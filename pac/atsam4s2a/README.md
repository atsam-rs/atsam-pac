# Microchip/Atmel ATSAM4S2A PAC for Rust

This repository holds the Peripheral Access Crate for the Atmel `ATSAM4S2A` microcontroller.

[![Docs](https://docs.rs/atsam4s2a-pac/badge.svg)](https://docs.rs/atsam4s2a-pac/latest/)
