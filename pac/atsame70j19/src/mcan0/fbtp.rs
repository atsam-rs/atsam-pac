#[doc = "Reader of register FBTP"]
pub type R = crate::R<u32, super::FBTP>;
#[doc = "Writer for register FBTP"]
pub type W = crate::W<u32, super::FBTP>;
#[doc = "Register FBTP `reset()`'s with value 0"]
impl crate::ResetValue for super::FBTP {
    type Type = u32;
    #[inline(always)]
