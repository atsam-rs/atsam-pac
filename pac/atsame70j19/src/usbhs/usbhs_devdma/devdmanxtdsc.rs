#[doc = "Reader of register DEVDMANXTDSC"]
pub type R = crate::R<u32, super::DEVDMANXTDSC>;
#[doc = "Writer for register DEVDMANXTDSC"]
pub type W = crate::W<u32, super::DEVDMANXTDSC>;
#[doc = "Register DEVDMANXTDSC `reset()`'s with value 0"]
impl crate::ResetValue for super::DEVDMANXTDSC {
    type Type = u32;
    #[inline(always)]
