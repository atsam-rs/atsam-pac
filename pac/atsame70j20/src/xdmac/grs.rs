#[doc = "Reader of register GRS"]
pub type R = crate::R<u32, super::GRS>;
#[doc = "Writer for register GRS"]
pub type W = crate::W<u32, super::GRS>;
#[doc = "Register GRS `reset()`'s with value 0"]
impl crate::ResetValue for super::GRS {
    type Type = u32;
    #[inline(always)]
