#[doc = "Reader of register DMA_C_ADDR"]
pub type R = crate::R<u32, super::DMA_C_ADDR>;
#[doc = "Writer for register DMA_C_ADDR"]
pub type W = crate::W<u32, super::DMA_C_ADDR>;
#[doc = "Register DMA_C_ADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_C_ADDR {
    type Type = u32;
    #[inline(always)]
