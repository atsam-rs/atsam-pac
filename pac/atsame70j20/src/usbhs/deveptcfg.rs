...
pub type EPBK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVEPTCFG_SPEC, u8, EPBKSELECT_A, 2, O>;
...
pub type EPSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DEVEPTCFG_SPEC, u8, EPSIZESELECT_A, 3, O>;
...
pub type EPDIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTCFG_SPEC, EPDIRSELECT_A, O>;
...
pub type EPTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DEVEPTCFG_SPEC, u8, EPTYPESELECT_A, 2, O>;
...
pub type NBTRANS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DEVEPTCFG_SPEC, u8, NBTRANSSELECT_A, 2, O>;
