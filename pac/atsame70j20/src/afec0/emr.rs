...
pub type CMPMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EMR_SPEC, u8, CMPMODESELECT_A, 2, O>;
...
pub type RES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMR_SPEC, u8, RESSELECT_A, 3, O>;
...
pub type SIGNMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, EMR_SPEC, u8, SIGNMODESELECT_A, 2, O>;
