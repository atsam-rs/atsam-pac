...
pub type GCEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SMMR_SPEC, bool, O>;
#[doc = "Field `DOWN` reader - Down Count"]
pub type DOWN_R = crate::BitReader<bool>;
#[doc = "Field `DOWN` writer - Down Count"]
pub type DOWN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SMMR_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets SMMR%s to value 0"]
