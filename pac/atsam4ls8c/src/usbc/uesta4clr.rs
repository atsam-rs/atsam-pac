#[doc = "Writer for register UESTA4CLR"]
pub type W = crate::W<u32, super::UESTA4CLR>;
#[doc = "Register UESTA4CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA4CLR {
    type Type = u32;
    #[inline(always)]
