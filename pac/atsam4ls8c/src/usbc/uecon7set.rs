#[doc = "Writer for register UECON7SET"]
pub type W = crate::W<u32, super::UECON7SET>;
#[doc = "Register UECON7SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON7SET {
    type Type = u32;
    #[inline(always)]
