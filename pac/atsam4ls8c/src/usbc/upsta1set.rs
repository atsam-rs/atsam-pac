#[doc = "Writer for register UPSTA1SET"]
pub type W = crate::W<u32, super::UPSTA1SET>;
#[doc = "Register UPSTA1SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA1SET {
    type Type = u32;
    #[inline(always)]
