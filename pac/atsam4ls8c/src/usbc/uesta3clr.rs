#[doc = "Writer for register UESTA3CLR"]
pub type W = crate::W<u32, super::UESTA3CLR>;
#[doc = "Register UESTA3CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA3CLR {
    type Type = u32;
    #[inline(always)]
