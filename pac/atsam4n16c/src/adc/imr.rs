...
#[doc = "Field `EOC16` reader - End of Conversion Interrupt Mask 16"]
pub type EOC16_R = crate::BitReader<bool>;
...
impl R {
    ...
    pub fn eoc16(&self) -> EOC16_R {
        EOC16_R::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 19 - Temperature Change Interrupt Mask"]
    #[inline(always)]
    pub fn tempchg(&self) -> TEMPCHG_R {
        TEMPCHG_R::new(((self.bits >> 19) & 1) != 0)
    }
