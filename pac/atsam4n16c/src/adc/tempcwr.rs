...
pub type TLOWTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TEMPCWR_SPEC, u16, u16, 12, O>;
...
pub type THIGHTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TEMPCWR_SPEC, u16, u16, 12, O>;
impl R {
