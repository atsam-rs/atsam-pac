...
#[repr(u8)]
pub enum MOSCRCF_A {
    #[doc = "0: The Fast RC Oscillator Frequency is at 12 MHz (default)"]
    _12_MHZ = 0,
    #[doc = "1: The Fast RC Oscillator Frequency is at 8 MHz"]
    _8_MHZ = 1,
    #[doc = "2: The Fast RC Oscillator Frequency is at 4 MHz"]
    _4_MHZ = 2,
}
...
impl MOSCRCF_R {
    ...
    pub fn variant(&self) -> Option<MOSCRCF_A> {
        match self.bits {
            0 => Some(MOSCRCF_A::_12_MHZ),
            1 => Some(MOSCRCF_A::_8_MHZ),
            2 => Some(MOSCRCF_A::_4_MHZ),
            _ => None,
        }
    }
...
impl<'a, const O: u8> MOSCRCF_W<'a, O> {
    #[doc = "The Fast RC Oscillator Frequency is at 12 MHz (default)"]
    #[inline(always)]
    ...
    #[doc = "The Fast RC Oscillator Frequency is at 4 MHz"]
    #[inline(always)]
...
#[doc = "Field `XT32KFME` reader - Slow Crystal Oscillator Frequency Monitoring Enable"]
pub type XT32KFME_R = crate::BitReader<bool>;
#[doc = "Field `XT32KFME` writer - Slow Crystal Oscillator Frequency Monitoring Enable"]
pub type XT32KFME_W<'a, const O: u8> = crate::BitWriter<'a, u32, CKGR_MOR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 26 - Slow Crystal Oscillator Frequency Monitoring Enable"]
    #[inline(always)]
