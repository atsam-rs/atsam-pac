#[doc = "Reader of register CNDC"]
pub type R = crate::R<u32, super::CNDC>;
#[doc = "Writer for register CNDC"]
pub type W = crate::W<u32, super::CNDC>;
#[doc = "Register CNDC `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDC {
    type Type = u32;
    #[inline(always)]
