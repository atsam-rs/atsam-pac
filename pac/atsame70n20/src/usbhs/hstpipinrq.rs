#[doc = "Reader of register HSTPIPINRQ[%s]"]
pub type R = crate::R<u32, super::HSTPIPINRQ>;
#[doc = "Writer for register HSTPIPINRQ[%s]"]
pub type W = crate::W<u32, super::HSTPIPINRQ>;
#[doc = "Register HSTPIPINRQ[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPINRQ {
    type Type = u32;
    #[inline(always)]
