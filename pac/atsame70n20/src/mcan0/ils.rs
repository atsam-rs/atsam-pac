...
#[doc = "Field `CRCEL` reader - CRC Error Interrupt Line"]
pub type CRCEL_R = crate::BitReader<bool>;
#[doc = "Field `CRCEL` writer - CRC Error Interrupt Line"]
pub type CRCEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILS_SPEC, bool, O>;
#[doc = "Field `BEL` reader - Bit Error Interrupt Line"]
pub type BEL_R = crate::BitReader<bool>;
#[doc = "Field `BEL` writer - Bit Error Interrupt Line"]
pub type BEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILS_SPEC, bool, O>;
#[doc = "Field `ACKEL` reader - Acknowledge Error Interrupt Line"]
pub type ACKEL_R = crate::BitReader<bool>;
#[doc = "Field `ACKEL` writer - Acknowledge Error Interrupt Line"]
pub type ACKEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILS_SPEC, bool, O>;
#[doc = "Field `FOEL` reader - Format Error Interrupt Line"]
pub type FOEL_R = crate::BitReader<bool>;
#[doc = "Field `FOEL` writer - Format Error Interrupt Line"]
pub type FOEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILS_SPEC, bool, O>;
#[doc = "Field `STEL` reader - Stuff Error Interrupt Line"]
pub type STEL_R = crate::BitReader<bool>;
#[doc = "Field `STEL` writer - Stuff Error Interrupt Line"]
pub type STEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, ILS_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crcel(&mut self) -> CRCEL_W<27> {
        CRCEL_W::new(self)
    }
    #[doc = "Bit 28 - Bit Error Interrupt Line"]
    #[inline(always)]
    #[must_use]
    pub fn bel(&mut self) -> BEL_W<28> {
        BEL_W::new(self)
    }
    #[doc = "Bit 29 - Acknowledge Error Interrupt Line"]
    #[inline(always)]
    #[must_use]
    pub fn ackel(&mut self) -> ACKEL_W<29> {
        ACKEL_W::new(self)
    }
    #[doc = "Bit 30 - Format Error Interrupt Line"]
    #[inline(always)]
    #[must_use]
    pub fn foel(&mut self) -> FOEL_W<30> {
        FOEL_W::new(self)
    }
    #[doc = "Bit 31 - Stuff Error Interrupt Line"]
    #[inline(always)]
    #[must_use]
    pub fn stel(&mut self) -> STEL_W<31> {
        STEL_W::new(self)
    }
