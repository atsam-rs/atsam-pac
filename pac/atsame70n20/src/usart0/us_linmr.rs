...
pub type NACT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, US_LINMR_SPEC, u8, NACTSELECT_A, 2, O>;
...
pub type FSDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_LINMR_SPEC, bool, O>;
...
pub type WKUPTYP_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_LINMR_SPEC, bool, O>;
#[doc = "Field `DLC` reader - Data Length Control"]
pub type DLC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DLC` writer - Data Length Control"]
pub type DLC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, US_LINMR_SPEC, u8, u8, 8, O>;
#[doc = "Field `PDCM` reader - DMAC Mode"]
pub type PDCM_R = crate::BitReader<bool>;
#[doc = "Field `PDCM` writer - DMAC Mode"]
pub type PDCM_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_LINMR_SPEC, bool, O>;
...
pub type SYNCDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_LINMR_SPEC, bool, O>;
impl R {
