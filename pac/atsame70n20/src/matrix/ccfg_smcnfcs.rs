...
pub type SDRAMEN_R = crate::BitReader<bool>;
#[doc = "Field `SDRAMEN` writer - SDRAM Enable"]
pub type SDRAMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCFG_SMCNFCS_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdramen(&mut self) -> SDRAMEN_W<4> {
        SDRAMEN_W::new(self)
    }
