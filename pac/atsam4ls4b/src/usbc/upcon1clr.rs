#[doc = "Writer for register UPCON1CLR"]
pub type W = crate::W<u32, super::UPCON1CLR>;
#[doc = "Register UPCON1CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON1CLR {
    type Type = u32;
    #[inline(always)]
