#[doc = "Writer for register UESTA1CLR"]
pub type W = crate::W<u32, super::UESTA1CLR>;
#[doc = "Register UESTA1CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA1CLR {
    type Type = u32;
    #[inline(always)]
