#[doc = "Writer for register UPSTA4CLR"]
pub type W = crate::W<u32, super::UPSTA4CLR>;
#[doc = "Register UPSTA4CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA4CLR {
    type Type = u32;
    #[inline(always)]
