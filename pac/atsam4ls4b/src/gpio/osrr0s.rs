#[doc = "Reader of register OSRR0S%s"]
pub type R = crate::R<u32, super::OSRR0S>;
#[doc = "Writer for register OSRR0S%s"]
pub type W = crate::W<u32, super::OSRR0S>;
#[doc = "Register OSRR0S%s `reset()`'s with value 0"]
impl crate::ResetValue for super::OSRR0S {
    type Type = u32;
    #[inline(always)]
