#[doc = "Reader of register ASYNC"]
pub type R = crate::R<u32, super::ASYNC>;
#[doc = "Writer for register ASYNC"]
pub type W = crate::W<u32, super::ASYNC>;
#[doc = "Register ASYNC `reset()`'s with value 0"]
impl crate::ResetValue for super::ASYNC {
    type Type = u32;
    #[inline(always)]
