#[doc = "Writer for register CR_USART"]
pub type W = crate::W<u32, super::CR_USART>;
#[doc = "Register CR_USART `reset()`'s with value 0"]
impl crate::ResetValue for super::CR_USART {
    type Type = u32;
    #[inline(always)]
