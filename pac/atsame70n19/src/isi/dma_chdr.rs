#[doc = "Writer for register DMA_CHDR"]
pub type W = crate::W<u32, super::DMA_CHDR>;
#[doc = "Register DMA_CHDR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_CHDR {
    type Type = u32;
    #[inline(always)]
