#[doc = "Reader of register TIDM3"]
pub type R = crate::R<u32, super::TIDM3>;
#[doc = "Writer for register TIDM3"]
pub type W = crate::W<u32, super::TIDM3>;
#[doc = "Register TIDM3 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIDM3 {
    type Type = u32;
    #[inline(always)]
