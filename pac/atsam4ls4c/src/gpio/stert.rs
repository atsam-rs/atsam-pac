#[doc = "Reader of register STERT%s"]
pub type R = crate::R<u32, super::STERT>;
#[doc = "Writer for register STERT%s"]
pub type W = crate::W<u32, super::STERT>;
#[doc = "Register STERT%s `reset()`'s with value 0"]
impl crate::ResetValue for super::STERT {
    type Type = u32;
    #[inline(always)]
