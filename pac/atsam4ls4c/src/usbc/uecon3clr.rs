#[doc = "Writer for register UECON3CLR"]
pub type W = crate::W<u32, super::UECON3CLR>;
#[doc = "Register UECON3CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON3CLR {
    type Type = u32;
    #[inline(always)]
