#[doc = "Writer for register UESTA2CLR"]
pub type W = crate::W<u32, super::UESTA2CLR>;
#[doc = "Register UESTA2CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA2CLR {
    type Type = u32;
    #[inline(always)]
