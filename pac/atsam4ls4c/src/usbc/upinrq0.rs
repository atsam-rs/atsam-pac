#[doc = "Reader of register UPINRQ0"]
pub type R = crate::R<u32, super::UPINRQ0>;
#[doc = "Writer for register UPINRQ0"]
pub type W = crate::W<u32, super::UPINRQ0>;
#[doc = "Register UPINRQ0 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ0 {
    type Type = u32;
    #[inline(always)]
