...
#[doc = "Field `DRDY` writer - Data Ready Interrupt Status Clear"]
pub type DRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_SPEC, bool, O>;
#[doc = "Field `OVR` writer - Overrun Interrupt Status Clear"]
