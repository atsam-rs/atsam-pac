...
pub enum UPDM_A {
    ...
    MODE1 = 1,
    #[doc = "2: Automatic write of duty-cycle update registers by the Peripheral DMA Controller and automatic update of synchronous channels"]
    MODE2 = 2,
}
...
impl<'a> UPDM_W<'a> {
    ...
    #[doc = "Automatic write of duty-cycle update registers by the Peripheral DMA Controller and automatic update of synchronous channels"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 20 - Peripheral DMA Controller Transfer Request Mode"]
    #[inline(always)]
    pub fn ptrm(&self) -> PTRM_R {
        PTRM_R::new(((self.bits >> 20) & 0x01) != 0)
    }
    #[doc = "Bits 21:23 - Peripheral DMA Controller Transfer Request Comparison Selection"]
    #[inline(always)]
