# Microchip/Atmel ATSAM4S2B PAC for Rust

This repository holds the Peripheral Access Crate for the Atmel `ATSAM4S2B` microcontroller.

[![Docs](https://docs.rs/atsam4s2b-pac/badge.svg)](https://docs.rs/atsam4s2b-pac/latest/)
