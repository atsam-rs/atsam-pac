...
pub type DCONNIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DDISCIS` writer - Device Disconnection Interrupt Set"]
pub type DDISCIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `RSTIS` writer - USB Reset Sent Interrupt Set"]
pub type RSTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `RSMEDIS` writer - Downstream Resume Sent Interrupt Set"]
pub type RSMEDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `RXRSMIS` writer - Upstream Resume Received Interrupt Set"]
pub type RXRSMIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `HSOFIS` writer - Host Start of Frame Interrupt Set"]
pub type HSOFIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `HWUPIS` writer - Host Wake-Up Interrupt Set"]
pub type HWUPIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_1` writer - DMA Channel 0 Interrupt Set"]
pub type DMA_1_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_2` writer - DMA Channel 1 Interrupt Set"]
pub type DMA_2_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_3` writer - DMA Channel 2 Interrupt Set"]
pub type DMA_3_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_4` writer - DMA Channel 3 Interrupt Set"]
pub type DMA_4_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_5` writer - DMA Channel 4 Interrupt Set"]
pub type DMA_5_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_6` writer - DMA Channel 5 Interrupt Set"]
pub type DMA_6_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
#[doc = "Field `DMA_7` writer - DMA Channel 6 Interrupt Set"]
pub type DMA_7_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTIFR_SPEC, bool, O>;
impl W {
