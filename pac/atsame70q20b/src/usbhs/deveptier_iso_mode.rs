#[doc = "Writer for register DEVEPTIER_ISO_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIER_ISO_MODE>;
#[doc = "Register DEVEPTIER_ISO_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIER_ISO_MODE {
    type Type = u32;
    #[inline(always)]
