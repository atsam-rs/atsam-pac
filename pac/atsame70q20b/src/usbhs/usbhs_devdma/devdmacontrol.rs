#[doc = "Register `DEVDMACONTROL` reader"]
pub struct R(crate::R<DEVDMACONTROL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEVDMACONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEVDMACONTROL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEVDMACONTROL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DEVDMACONTROL` writer"]
pub struct W(crate::W<DEVDMACONTROL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVDMACONTROL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DEVDMACONTROL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVDMACONTROL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANN_ENB_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type LDNXT_DSC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type END_TR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type END_B_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type END_TR_IT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type END_BUFFIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type DESC_LD_IT_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type BURST_LCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVDMACONTROL_SPEC, bool, O>;
...
pub type BUFF_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DEVDMACONTROL_SPEC, u16, u16, 16, O>;
impl R {
...
#[doc = "Device DMA Channel Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [devdmacontrol](index.html) module"]
pub struct DEVDMACONTROL_SPEC;
impl crate::RegisterSpec for DEVDMACONTROL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [devdmacontrol::R](R) reader structure"]
impl crate::Readable for DEVDMACONTROL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [devdmacontrol::W](W) writer structure"]
impl crate::Writable for DEVDMACONTROL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DEVDMACONTROL to value 0"]
impl crate::Resettable for DEVDMACONTROL_SPEC {
