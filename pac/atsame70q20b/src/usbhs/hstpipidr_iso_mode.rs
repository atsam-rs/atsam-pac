...
pub type RXINEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTEC` writer - Transmitted OUT Data Interrupt Disable"]
pub type TXOUTEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `UNDERFIEC` writer - Underflow Interrupt Disable"]
pub type UNDERFIEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `PERREC` writer - Pipe Error Interrupt Disable"]
pub type PERREC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDEC` writer - NAKed Interrupt Disable"]
pub type NAKEDEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIEC` writer - Overflow Interrupt Disable"]
pub type OVERFIEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `CRCERREC` writer - CRC Error Interrupt Disable"]
pub type CRCERREC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `SHORTPACKETIEC` writer - Short Packet Interrupt Disable"]
pub type SHORTPACKETIEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `NBUSYBKEC` writer - Number of Busy Banks Disable"]
pub type NBUSYBKEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `FIFOCONC` writer - FIFO Control Disable"]
pub type FIFOCONC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `PDISHDMAC` writer - Pipe Interrupts Disable HDMA Request Disable"]
pub type PDISHDMAC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `PFREEZEC` writer - Pipe Freeze Disable"]
pub type PFREEZEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_ISO_MODE_SPEC, bool, O>;
impl W {
...
#[doc = "`reset()` method sets HSTPIPIDR_ISO_MODE[%s]
to value 0"]
impl crate::Resettable for HSTPIPIDR_ISO_MODE_SPEC {
