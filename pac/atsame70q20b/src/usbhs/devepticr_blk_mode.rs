#[doc = "Writer for register DEVEPTICR_BLK_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTICR_BLK_MODE>;
#[doc = "Register DEVEPTICR_BLK_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTICR_BLK_MODE {
    type Type = u32;
    #[inline(always)]
