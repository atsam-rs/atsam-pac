#[doc = "Writer for register DEVEPTICR_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTICR_INTRPT_MODE>;
#[doc = "Register DEVEPTICR_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTICR_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
