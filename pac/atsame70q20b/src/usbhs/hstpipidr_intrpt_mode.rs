#[doc = "Writer for register HSTPIPIDR_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIDR_INTRPT_MODE>;
#[doc = "Register HSTPIPIDR_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIDR_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
