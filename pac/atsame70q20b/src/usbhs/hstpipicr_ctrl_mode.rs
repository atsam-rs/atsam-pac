#[doc = "Writer for register HSTPIPICR_CTRL_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPICR_CTRL_MODE>;
#[doc = "Register HSTPIPICR_CTRL_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPICR_CTRL_MODE {
    type Type = u32;
    #[inline(always)]
