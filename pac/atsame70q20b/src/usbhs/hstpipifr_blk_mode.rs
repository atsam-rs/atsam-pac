#[doc = "Writer for register HSTPIPIFR_BLK_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIFR_BLK_MODE>;
#[doc = "Register HSTPIPIFR_BLK_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIFR_BLK_MODE {
    type Type = u32;
    #[inline(always)]
