...
pub type RXINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTIC` writer - Transmitted OUT Data Interrupt Clear"]
pub type TXOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `UNDERFIC` writer - Underflow Interrupt Clear"]
pub type UNDERFIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDIC` writer - NAKed Interrupt Clear"]
pub type NAKEDIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIC` writer - Overflow Interrupt Clear"]
pub type OVERFIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `CRCERRIC` writer - CRC Error Interrupt Clear"]
pub type CRCERRIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `SHORTPACKETIC` writer - Short Packet Interrupt Clear"]
pub type SHORTPACKETIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPICR_ISO_MODE_SPEC, bool, O>;
impl W {
