...
pub type USART_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, US_MR_SPI_MODE_SPEC, u8, USART_MODESELECT_A, 4, O>;
...
pub type USCLKS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, US_MR_SPI_MODE_SPEC, u8, USCLKSSELECT_A, 2, O>;
...
pub type CHRL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, US_MR_SPI_MODE_SPEC, u8, CHRLSELECT_A, 2, O>;
