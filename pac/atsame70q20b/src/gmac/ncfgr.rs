...
impl From<CLKSELECT_A> for u8 {
    #[inline(always)]
    fn from(variant: CLKSELECT_A) -> Self {
        variant as _
    }
}
impl CLK_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CLKSELECT_A> {
        match self.bits {
            0 => Some(CLKSELECT_A::MCK_8),
            1 => Some(CLKSELECT_A::MCK_16),
            2 => Some(CLKSELECT_A::MCK_32),
            3 => Some(CLKSELECT_A::MCK_48),
            4 => Some(CLKSELECT_A::MCK_64),
            5 => Some(CLKSELECT_A::MCK_96),
            _ => None,
        }
    }
...
#[doc = "`reset()` method sets NCFGR to value 0"]
