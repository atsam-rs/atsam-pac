...
pub struct R(crate::R<SETUP2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SETUP2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SETUP2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SETUP2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SETUP2` writer"]
pub struct W(crate::W<SETUP2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SETUP2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SETUP2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SETUP2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP2_SPEC, u8, u8, 6, O>;
...
pub type NCS_WR_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP2_SPEC, u8, u8, 6, O>;
...
pub type NRD_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP2_SPEC, u8, u8, 6, O>;
...
pub type NCS_RD_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP2_SPEC, u8, u8, 6, O>;
impl R {
...
#[doc = "SMC Setup Register (CS_number = 2)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [setup2](index.html) module"]
pub struct SETUP2_SPEC;
impl crate::RegisterSpec for SETUP2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [setup2::R](R) reader structure"]
impl crate::Readable for SETUP2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [setup2::W](W) writer structure"]
impl crate::Writable for SETUP2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SETUP2 to value 0x0101_0101"]
impl crate::Resettable for SETUP2_SPEC {
