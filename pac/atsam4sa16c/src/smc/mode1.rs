...
pub struct R(crate::R<MODE1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MODE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MODE1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MODE1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MODE1` writer"]
pub struct W(crate::W<MODE1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MODE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MODE1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MODE1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type READ_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, bool, O>;
#[doc = "Field `WRITE_MODE` reader - "]
pub type WRITE_MODE_R = crate::BitReader<bool>;
#[doc = "Field `WRITE_MODE` writer - "]
pub type WRITE_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, bool, O>;
...
pub type EXNW_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MODE1_SPEC, u8, EXNW_MODE_A, 2, O>;
...
pub type TDF_CYCLES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MODE1_SPEC, u8, u8, 4, O>;
...
pub type TDF_MODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, bool, O>;
#[doc = "Field `PMEN` reader - Page Mode Enabled"]
pub type PMEN_R = crate::BitReader<bool>;
#[doc = "Field `PMEN` writer - Page Mode Enabled"]
pub type PMEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MODE1_SPEC, bool, O>;
...
pub type PS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, MODE1_SPEC, u8, PS_A, 2, O>;
