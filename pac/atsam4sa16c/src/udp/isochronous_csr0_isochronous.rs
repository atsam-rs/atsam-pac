...
pub type TXCOMP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, ISOCHRONOUS_CSR0_ISOCHRONOUS_SPEC, bool, O>;
...
pub type EPTYPE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ISOCHRONOUS_CSR0_ISOCHRONOUS_SPEC, u8, EPTYPE_A, 3, O>;
...
pub type RXBYTECNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, ISOCHRONOUS_CSR0_ISOCHRONOUS_SPEC, u16, u16, 11, O>;
impl R {
