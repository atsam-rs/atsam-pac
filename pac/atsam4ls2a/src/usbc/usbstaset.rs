#[doc = "Writer for register USBSTASET"]
pub type W = crate::W<u32, super::USBSTASET>;
#[doc = "Register USBSTASET `reset()`'s with value 0"]
impl crate::ResetValue for super::USBSTASET {
    type Type = u32;
    #[inline(always)]
