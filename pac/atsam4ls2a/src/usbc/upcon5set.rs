#[doc = "Writer for register UPCON5SET"]
pub type W = crate::W<u32, super::UPCON5SET>;
#[doc = "Register UPCON5SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON5SET {
    type Type = u32;
    #[inline(always)]
