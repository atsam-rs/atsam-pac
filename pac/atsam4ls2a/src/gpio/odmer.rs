#[doc = "Reader of register ODMER%s"]
pub type R = crate::R<u32, super::ODMER>;
#[doc = "Writer for register ODMER%s"]
pub type W = crate::W<u32, super::ODMER>;
#[doc = "Register ODMER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::ODMER {
    type Type = u32;
    #[inline(always)]
