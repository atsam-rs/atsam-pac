#[doc = "Reader of register OSRR0C%s"]
pub type R = crate::R<u32, super::OSRR0C>;
#[doc = "Writer for register OSRR0C%s"]
pub type W = crate::W<u32, super::OSRR0C>;
#[doc = "Register OSRR0C%s `reset()`'s with value 0"]
impl crate::ResetValue for super::OSRR0C {
    type Type = u32;
    #[inline(always)]
