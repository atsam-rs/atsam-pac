...
pub type NDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNDC_SPEC, NDESELECT_A, O>;
...
pub type NDSUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNDC_SPEC, NDSUPSELECT_A, O>;
...
pub type NDDUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CNDC_SPEC, NDDUPSELECT_A, O>;
...
pub type NDVIEW_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CNDC_SPEC, u8, NDVIEWSELECT_A, 2, O>;
