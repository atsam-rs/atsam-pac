...
pub type TRGEN0_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIGR_SPEC, TRGEN0SELECT_A, O>;
...
pub type TRGEN1_W<'a, const O: u8> = crate::BitWriter<'a, u32, TRIGR_SPEC, TRGEN1SELECT_A, O>;
...
pub type TRGSEL0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TRIGR_SPEC, u8, TRGSEL0SELECT_A, 3, O>;
...
pub type TRGSEL1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, TRIGR_SPEC, u8, TRGSEL1SELECT_A, 3, O>;
...
pub type OSR0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRIGR_SPEC, u8, OSR0SELECT_A, 3, O>;
...
pub type OSR1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TRIGR_SPEC, u8, OSR1SELECT_A, 3, O>;
