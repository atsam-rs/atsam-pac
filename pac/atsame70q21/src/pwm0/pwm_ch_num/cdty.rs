#[doc = "Reader of register CDTY"]
pub type R = crate::R<u32, super::CDTY>;
#[doc = "Writer for register CDTY"]
pub type W = crate::W<u32, super::CDTY>;
#[doc = "Register CDTY `reset()`'s with value 0"]
impl crate::ResetValue for super::CDTY {
    type Type = u32;
    #[inline(always)]
