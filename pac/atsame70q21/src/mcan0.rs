...
pub mod cust;
#[doc = "FBTP (rw) register accessor: an alias for `Reg<FBTP_SPEC>`"]
pub type FBTP = crate::Reg<fbtp::FBTP_SPEC>;
...
pub mod cccr;
#[doc = "BTP (rw) register accessor: an alias for `Reg<BTP_SPEC>`"]
pub type BTP = crate::Reg<btp::BTP_SPEC>;
