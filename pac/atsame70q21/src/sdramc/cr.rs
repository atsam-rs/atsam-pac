...
pub type NC_R = crate::FieldReader<u8, NCSELECT_A>;
...
impl From<NCSELECT_A> for u8 {
    #[inline(always)]
    fn from(variant: NCSELECT_A) -> Self {
        variant as _
    }
}
impl NC_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> NCSELECT_A {
        match self.bits {
            0 => NCSELECT_A::COL8,
            1 => NCSELECT_A::COL9,
            2 => NCSELECT_A::COL10,
...
impl From<NRSELECT_A> for u8 {
    #[inline(always)]
    fn from(variant: NRSELECT_A) -> Self {
        variant as _
    }
}
impl NR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<NRSELECT_A> {
        match self.bits {
            0 => Some(NRSELECT_A::ROW11),
            1 => Some(NRSELECT_A::ROW12),
            2 => Some(NRSELECT_A::ROW13),
            _ => None,
        }
    }
...
impl From<NBSELECT_A> for bool {
    #[inline(always)]
    fn from(variant: NBSELECT_A) -> Self {
        variant as u8 != 0
    }
}
impl NB_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> NBSELECT_A {
        match self.bits {
            false => NBSELECT_A::BANK2,
            true => NBSELECT_A::BANK4,
        }
    }
    #[doc = "Checks if the value of the field is `BANK2`"]
    #[inline(always)]
    pub fn is_bank2(&self) -> bool {
        *self == NBSELECT_A::BANK2
    }
    #[doc = "Checks if the value of the field is `BANK4`"]
    #[inline(always)]
    pub fn is_bank4(&self) -> bool {
        *self == NBSELECT_A::BANK4
    }
}
#[doc = "Field `NB` writer - Number of Banks"]
pub type NB_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR_SPEC, NBSELECT_A, O>;
impl<'a, const O: u8> NB_W<'a, O> {
    #[doc = "2 banks"]
    #[inline(always)]
    pub fn bank2(self) -> &'a mut W {
        self.variant(NBSELECT_A::BANK2)
    }
    #[doc = "4 banks"]
    #[inline(always)]
    pub fn bank4(self) -> &'a mut W {
        self.variant(NBSELECT_A::BANK4)
    }
}
#[doc = "Field `CAS` reader - CAS Latency"]
pub type CAS_R = crate::FieldReader<u8, CASSELECT_A>;
#[doc = "CAS Latency\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum CASSELECT_A {
...
impl From<CASSELECT_A> for u8 {
    #[inline(always)]
    fn from(variant: CASSELECT_A) -> Self {
        variant as _
    }
}
impl CAS_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CASSELECT_A> {
        match self.bits {
            1 => Some(CASSELECT_A::LATENCY1),
            2 => Some(CASSELECT_A::LATENCY2),
            3 => Some(CASSELECT_A::LATENCY3),
            _ => None,
        }
    }
