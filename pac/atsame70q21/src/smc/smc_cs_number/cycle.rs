...
pub type NWE_CYCLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CYCLE_SPEC, u16, u16, 9, O>;
...
pub type NRD_CYCLE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CYCLE_SPEC, u16, u16, 9, O>;
impl R {
