...
pub type FILTER_W<'a, const O: u8> = crate::BitWriter<'a, u32, MR_SPEC, FILTERSELECT_A, O>;
...
pub type PAR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MR_SPEC, u8, PARSELECT_A, 3, O>;
...
pub type BRSRCCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, MR_SPEC, BRSRCCKSELECT_A, O>;
...
pub type CHMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, MR_SPEC, u8, CHMODESELECT_A, 2, O>;
