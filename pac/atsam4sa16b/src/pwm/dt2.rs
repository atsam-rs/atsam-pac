...
pub struct R(crate::R<DT2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DT2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DT2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DT2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DT2` writer"]
pub struct W(crate::W<DT2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DT2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DT2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DT2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DT2_SPEC, u16, u16, 16, O>;
...
pub type DTL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DT2_SPEC, u16, u16, 16, O>;
impl R {
