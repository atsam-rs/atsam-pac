...
impl W {
    ...
    #[doc = "Bit 3 - End of Receive Buffer Transfer Interrupt Disable"]
    #[inline(always)]
    pub fn endrx(&mut self) -> ENDRX_W {
        ENDRX_W { w: self }
    }
    #[doc = "Bit 4 - End of Transmit Buffer Interrupt Disable"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - Transmit Buffer Empty Interrupt Disable"]
    #[inline(always)]
    pub fn txbufe(&mut self) -> TXBUFE_W {
        TXBUFE_W { w: self }
    }
    #[doc = "Bit 12 - Receive Buffer Full Interrupt Disable"]
    #[inline(always)]
