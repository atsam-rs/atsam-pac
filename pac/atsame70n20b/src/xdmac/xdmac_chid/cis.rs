...
pub type BIS_R = crate::BitReader<bool>;
#[doc = "Field `LIS` reader - End of Linked List Interrupt Status Bit"]
pub type LIS_R = crate::BitReader<bool>;
