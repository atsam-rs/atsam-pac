...
#[doc = "AFEC Analog Control Register"]
pub mod acr;
#[doc = "AFEC Sample & Hold Mode Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [shmr](shmr) module"]
pub type SHMR = crate::Reg<u32, _SHMR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _SHMR;
#[doc = "`read()` method returns [shmr::R](shmr::R) reader structure"]
impl crate::Readable for SHMR {}
#[doc = "`write(|w| ..)` method takes [shmr::W](shmr::W) writer structure"]
impl crate::Writable for SHMR {}
#[doc = "AFEC Sample & Hold Mode Register"]
pub mod shmr;
