#[doc = "Writer for register US_IDR_SPI_MODE"]
pub type W = crate::W<u32, super::US_IDR_SPI_MODE>;
#[doc = "Register US_IDR_SPI_MODE `reset()`'s with value 0"]
impl crate::ResetValue for super::US_IDR_SPI_MODE {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `NSSE`"]
pub struct NSSE_W<'a> {
    w: &'a mut W,
}
impl<'a> NSSE_W<'a> {
