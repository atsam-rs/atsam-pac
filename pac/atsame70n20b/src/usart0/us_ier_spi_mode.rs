...
pub type RXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IER_SPI_MODE_SPEC, bool, O>;
#[doc = "Field `TXRDY` writer - TXRDY Interrupt Enable"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IER_SPI_MODE_SPEC, bool, O>;
#[doc = "Field `OVRE` writer - Overrun Error Interrupt Enable"]
pub type OVRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IER_SPI_MODE_SPEC, bool, O>;
#[doc = "Field `TXEMPTY` writer - TXEMPTY Interrupt Enable"]
pub type TXEMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IER_SPI_MODE_SPEC, bool, O>;
#[doc = "Field `UNRE` writer - Underrun Error Interrupt Enable"]
pub type UNRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IER_SPI_MODE_SPEC, bool, O>;
#[doc = "Field `NSSE` writer - NSS Line (Driving CTS Pin) Rising or Falling Edge Event"]
pub type NSSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IER_SPI_MODE_SPEC, bool, O>;
impl W {
