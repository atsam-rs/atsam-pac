...
pub type LOWTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CWR_SPEC, u16, u16, 16, O>;
...
pub type HIGHTHRES_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CWR_SPEC, u16, u16, 16, O>;
impl R {
