#[doc = "Writer for register SCER"]
pub type W = crate::W<u32, super::SCER>;
#[doc = "Register SCER `reset()`'s with value 0"]
impl crate::ResetValue for super::SCER {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `PCK7`"]
pub struct PCK7_W<'a> {
    w: &'a mut W,
}
impl<'a> PCK7_W<'a> {
