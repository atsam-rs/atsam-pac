#[doc = "Writer for register DEVEPTIER_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIER_INTRPT_MODE>;
#[doc = "Register DEVEPTIER_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIER_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
