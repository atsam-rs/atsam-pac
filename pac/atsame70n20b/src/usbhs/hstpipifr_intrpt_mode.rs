#[doc = "Writer for register HSTPIPIFR_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIFR_INTRPT_MODE>;
#[doc = "Register HSTPIPIFR_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIFR_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
