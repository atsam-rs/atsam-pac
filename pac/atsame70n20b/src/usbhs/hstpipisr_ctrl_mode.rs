#[doc = "Register `HSTPIPISR_CTRL_MODE[%s]` reader"]
pub struct R(crate::R<HSTPIPISR_CTRL_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTPIPISR_CTRL_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTPIPISR_CTRL_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTPIPISR_CTRL_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Host Pipe Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstpipisr_ctrl_mode](index.html) module"]
pub struct HSTPIPISR_CTRL_MODE_SPEC;
impl crate::RegisterSpec for HSTPIPISR_CTRL_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hstpipisr_ctrl_mode::R](R) reader structure"]
impl crate::Readable for HSTPIPISR_CTRL_MODE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HSTPIPISR_CTRL_MODE[%s]
to value 0"]
impl crate::Resettable for HSTPIPISR_CTRL_MODE_SPEC {
