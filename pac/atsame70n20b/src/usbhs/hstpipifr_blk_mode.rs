...
pub type RXINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTIS` writer - Transmitted OUT Data Interrupt Set"]
pub type TXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `TXSTPIS` writer - Transmitted SETUP Interrupt Set"]
pub type TXSTPIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `PERRIS` writer - Pipe Error Interrupt Set"]
pub type PERRIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDIS` writer - NAKed Interrupt Set"]
pub type NAKEDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIS` writer - Overflow Interrupt Set"]
pub type OVERFIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTALLDIS` writer - Received STALLed Interrupt Set"]
pub type RXSTALLDIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
...
pub type NBUSYBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_BLK_MODE_SPEC, bool, O>;
impl W {
