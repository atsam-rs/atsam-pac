#[doc = "Reader of register CUST"]
pub type R = crate::R<u32, super::CUST>;
#[doc = "Writer for register CUST"]
pub type W = crate::W<u32, super::CUST>;
#[doc = "Register CUST `reset()`'s with value 0"]
impl crate::ResetValue for super::CUST {
    type Type = u32;
    #[inline(always)]
