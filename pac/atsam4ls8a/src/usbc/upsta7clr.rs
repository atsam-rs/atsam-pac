#[doc = "Writer for register UPSTA7CLR"]
pub type W = crate::W<u32, super::UPSTA7CLR>;
#[doc = "Register UPSTA7CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA7CLR {
    type Type = u32;
    #[inline(always)]
