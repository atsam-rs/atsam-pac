#[doc = "Writer for register UPCON3CLR"]
pub type W = crate::W<u32, super::UPCON3CLR>;
#[doc = "Register UPCON3CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON3CLR {
    type Type = u32;
    #[inline(always)]
