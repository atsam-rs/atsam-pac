#[doc = "Reader of register UPINRQ4"]
pub type R = crate::R<u32, super::UPINRQ4>;
#[doc = "Writer for register UPINRQ4"]
pub type W = crate::W<u32, super::UPINRQ4>;
#[doc = "Register UPINRQ4 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ4 {
    type Type = u32;
    #[inline(always)]
