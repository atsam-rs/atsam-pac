#[doc = "Writer for register UESTA7CLR"]
pub type W = crate::W<u32, super::UESTA7CLR>;
#[doc = "Register UESTA7CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA7CLR {
    type Type = u32;
    #[inline(always)]
