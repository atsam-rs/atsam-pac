#[doc = "Writer for register UECON3SET"]
pub type W = crate::W<u32, super::UECON3SET>;
#[doc = "Register UECON3SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON3SET {
    type Type = u32;
    #[inline(always)]
