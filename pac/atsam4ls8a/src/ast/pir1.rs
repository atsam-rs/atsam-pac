#[doc = "Reader of register PIR1"]
pub type R = crate::R<u32, super::PIR1>;
#[doc = "Writer for register PIR1"]
pub type W = crate::W<u32, super::PIR1>;
#[doc = "Register PIR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::PIR1 {
    type Type = u32;
    #[inline(always)]
