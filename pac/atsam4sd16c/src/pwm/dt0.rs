...
pub struct R(crate::R<DT0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DT0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DT0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DT0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DT0` writer"]
pub struct W(crate::W<DT0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DT0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DT0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DT0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DT0_SPEC, u16, u16, 16, O>;
...
pub type DTL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DT0_SPEC, u16, u16, 16, O>;
impl R {
