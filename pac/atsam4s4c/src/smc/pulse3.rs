...
impl From<crate::R<PULSE3_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PULSE3_SPEC>> for W {
    #[inline(always)]
...
pub type NWE_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE3_SPEC, u8, u8, 7, O>;
...
pub type NCS_WR_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE3_SPEC, u8, u8, 7, O>;
...
pub type NRD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE3_SPEC, u8, u8, 7, O>;
...
pub type NCS_RD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE3_SPEC, u8, u8, 7, O>;
impl R {
