...
pub type LCDCA__R = crate::BitReader<bool>;
#[doc = "Field `LCDCA_` writer - LCDCA APB Clock Enable"]
pub type LCDCA__W<'a, const O: u8> = crate::BitWriter<'a, u32, PBAMASK_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lcdca_(&mut self) -> LCDCA__W<23> {
        LCDCA__W::new(self)
    }
