#[doc = "Register `MR_USART` reader"]
pub struct R(crate::R<SPI_SLAVE_MODE_MR_USART_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI_SLAVE_MODE_MR_USART_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI_SLAVE_MODE_MR_USART_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI_SLAVE_MODE_MR_USART_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Interrupt Mask Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi_slave_mode_mr_usart](index.html) module"]
pub struct SPI_SLAVE_MODE_MR_USART_SPEC;
impl crate::RegisterSpec for SPI_SLAVE_MODE_MR_USART_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi_slave_mode_mr_usart::R](R) reader structure"]
impl crate::Readable for SPI_SLAVE_MODE_MR_USART_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MR_USART to value 0"]
impl crate::Resettable for SPI_SLAVE_MODE_MR_USART_SPEC {
    #[inline(always)]
