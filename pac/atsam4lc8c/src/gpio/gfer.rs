#[doc = "Reader of register GFER%s"]
pub type R = crate::R<u32, super::GFER>;
#[doc = "Writer for register GFER%s"]
pub type W = crate::W<u32, super::GFER>;
#[doc = "Register GFER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::GFER {
    type Type = u32;
    #[inline(always)]
