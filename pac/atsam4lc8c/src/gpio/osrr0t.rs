#[doc = "Reader of register OSRR0T%s"]
pub type R = crate::R<u32, super::OSRR0T>;
#[doc = "Writer for register OSRR0T%s"]
pub type W = crate::W<u32, super::OSRR0T>;
#[doc = "Register OSRR0T%s `reset()`'s with value 0"]
impl crate::ResetValue for super::OSRR0T {
    type Type = u32;
    #[inline(always)]
