#[doc = "Reader of register PUER%s"]
pub type R = crate::R<u32, super::PUER>;
#[doc = "Writer for register PUER%s"]
pub type W = crate::W<u32, super::PUER>;
#[doc = "Register PUER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PUER {
    type Type = u32;
    #[inline(always)]
