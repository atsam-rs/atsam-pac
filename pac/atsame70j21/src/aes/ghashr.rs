#[doc = "Reader of register GHASHR[%s]"]
pub type R = crate::R<u32, super::GHASHR>;
#[doc = "Writer for register GHASHR[%s]"]
pub type W = crate::W<u32, super::GHASHR>;
#[doc = "Register GHASHR[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::GHASHR {
    type Type = u32;
    #[inline(always)]
