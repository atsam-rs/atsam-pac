#[doc = "Reader of register BTP"]
pub type R = crate::R<u32, super::BTP>;
#[doc = "Writer for register BTP"]
pub type W = crate::W<u32, super::BTP>;
#[doc = "Register BTP `reset()`'s with value 0"]
impl crate::ResetValue for super::BTP {
    type Type = u32;
    #[inline(always)]
