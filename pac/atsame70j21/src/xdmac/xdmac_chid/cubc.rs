#[doc = "Reader of register CUBC"]
pub type R = crate::R<u32, super::CUBC>;
#[doc = "Writer for register CUBC"]
pub type W = crate::W<u32, super::CUBC>;
#[doc = "Register CUBC `reset()`'s with value 0"]
impl crate::ResetValue for super::CUBC {
    type Type = u32;
    #[inline(always)]
