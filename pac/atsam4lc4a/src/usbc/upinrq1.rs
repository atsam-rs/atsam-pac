#[doc = "Reader of register UPINRQ1"]
pub type R = crate::R<u32, super::UPINRQ1>;
#[doc = "Writer for register UPINRQ1"]
pub type W = crate::W<u32, super::UPINRQ1>;
#[doc = "Register UPINRQ1 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ1 {
    type Type = u32;
    #[inline(always)]
