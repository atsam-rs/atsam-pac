#[doc = "Writer for register UECON1CLR"]
pub type W = crate::W<u32, super::UECON1CLR>;
#[doc = "Register UECON1CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON1CLR {
    type Type = u32;
    #[inline(always)]
