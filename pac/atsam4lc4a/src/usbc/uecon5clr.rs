#[doc = "Writer for register UECON5CLR"]
pub type W = crate::W<u32, super::UECON5CLR>;
#[doc = "Register UECON5CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON5CLR {
    type Type = u32;
    #[inline(always)]
