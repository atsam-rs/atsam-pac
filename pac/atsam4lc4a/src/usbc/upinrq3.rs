#[doc = "Reader of register UPINRQ3"]
pub type R = crate::R<u32, super::UPINRQ3>;
#[doc = "Writer for register UPINRQ3"]
pub type W = crate::W<u32, super::UPINRQ3>;
#[doc = "Register UPINRQ3 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ3 {
    type Type = u32;
    #[inline(always)]
