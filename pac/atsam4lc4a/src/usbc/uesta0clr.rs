#[doc = "Writer for register UESTA0CLR"]
pub type W = crate::W<u32, super::UESTA0CLR>;
#[doc = "Register UESTA0CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA0CLR {
    type Type = u32;
    #[inline(always)]
