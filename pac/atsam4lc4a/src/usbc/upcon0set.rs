#[doc = "Writer for register UPCON0SET"]
pub type W = crate::W<u32, super::UPCON0SET>;
#[doc = "Register UPCON0SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON0SET {
    type Type = u32;
    #[inline(always)]
