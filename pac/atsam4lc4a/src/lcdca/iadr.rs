...
pub type DATA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IADR_SPEC, u8, u8, 8, O>;
#[doc = "Field `DMASK` writer - Data Mask"]
pub type DMASK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IADR_SPEC, u8, u8, 8, O>;
#[doc = "Field `OFF` writer - Byte Offset"]
pub type OFF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, IADR_SPEC, u8, u8, 5, O>;
impl W {
