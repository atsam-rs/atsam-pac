#[doc = "Reader of register CMPM"]
pub type R = crate::R<u32, super::CMPM>;
#[doc = "Writer for register CMPM"]
pub type W = crate::W<u32, super::CMPM>;
#[doc = "Register CMPM `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPM {
    type Type = u32;
    #[inline(always)]
