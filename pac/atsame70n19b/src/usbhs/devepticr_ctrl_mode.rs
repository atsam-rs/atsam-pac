#[doc = "Writer for register DEVEPTICR_CTRL_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTICR_CTRL_MODE>;
#[doc = "Register DEVEPTICR_CTRL_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTICR_CTRL_MODE {
    type Type = u32;
    #[inline(always)]
