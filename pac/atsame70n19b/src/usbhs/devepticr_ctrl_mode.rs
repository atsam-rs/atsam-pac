...
pub struct W(crate::W<DEVEPTICR_CTRL_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVEPTICR_CTRL_MODE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<DEVEPTICR_CTRL_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVEPTICR_CTRL_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TXINIC` writer - Transmitted IN Data Interrupt Clear"]
pub type TXINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTIC` writer - Received OUT Data Interrupt Clear"]
pub type RXOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTPIC` writer - Received SETUP Interrupt Clear"]
pub type RXSTPIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKOUTIC` writer - NAKed OUT Interrupt Clear"]
pub type NAKOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKINIC` writer - NAKed IN Interrupt Clear"]
pub type NAKINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIC` writer - Overflow Interrupt Clear"]
pub type OVERFIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `STALLEDIC` writer - STALLed Interrupt Clear"]
pub type STALLEDIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTICR_CTRL_MODE_SPEC, bool, O>;
...
#[doc = "Device Endpoint Interrupt Clear Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [devepticr_ctrl_mode](index.html) module"]
pub struct DEVEPTICR_CTRL_MODE_SPEC;
impl crate::RegisterSpec for DEVEPTICR_CTRL_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [devepticr_ctrl_mode::W](W) writer structure"]
impl crate::Writable for DEVEPTICR_CTRL_MODE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DEVEPTICR_CTRL_MODE[%s]
to value 0"]
impl crate::Resettable for DEVEPTICR_CTRL_MODE_SPEC {
