...
pub struct W(crate::W<HSTPIPIFR_INTRPT_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTPIPIFR_INTRPT_MODE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<HSTPIPIFR_INTRPT_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTPIPIFR_INTRPT_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RXINIS` writer - Received IN Data Interrupt Set"]
pub type RXINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTIS` writer - Transmitted OUT Data Interrupt Set"]
pub type TXOUTIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIFR_INTRPT_MODE_SPEC, bool, O>;
...
pub type PERRIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDIS` writer - NAKed Interrupt Set"]
pub type NAKEDIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIFR_INTRPT_MODE_SPEC, bool, O>;
...
#[doc = "Host Pipe Set Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstpipifr_intrpt_mode](index.html) module"]
pub struct HSTPIPIFR_INTRPT_MODE_SPEC;
impl crate::RegisterSpec for HSTPIPIFR_INTRPT_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [hstpipifr_intrpt_mode::W](W) writer structure"]
impl crate::Writable for HSTPIPIFR_INTRPT_MODE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HSTPIPIFR_INTRPT_MODE[%s]
to value 0"]
impl crate::Resettable for HSTPIPIFR_INTRPT_MODE_SPEC {
