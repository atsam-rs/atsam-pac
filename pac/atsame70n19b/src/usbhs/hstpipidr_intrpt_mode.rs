...
pub type RXINEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTEC` writer - Transmitted OUT Data Interrupt Disable"]
pub type TXOUTEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `UNDERFIEC` writer - Underflow Interrupt Disable"]
pub type UNDERFIEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `PERREC` writer - Pipe Error Interrupt Disable"]
pub type PERREC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDEC` writer - NAKed Interrupt Disable"]
pub type NAKEDEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIEC` writer - Overflow Interrupt Disable"]
pub type OVERFIEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
...
pub type PFREEZEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIDR_INTRPT_MODE_SPEC, bool, O>;
impl W {
