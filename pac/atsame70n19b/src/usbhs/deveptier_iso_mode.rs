...
pub type TXINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTES` writer - Received OUT Data Interrupt Enable"]
pub type RXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `UNDERFES` writer - Underflow Interrupt Enable"]
pub type UNDERFES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
...
pub type HBISOINERRES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
...
pub type OVERFES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `CRCERRES` writer - CRC Error Interrupt Enable"]
pub type CRCERRES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
...
pub type MDATAES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `DATAXES` writer - DataX Interrupt Enable"]
pub type DATAXES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
...
pub type NBUSYBKES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `KILLBKS` writer - Kill IN Bank"]
pub type KILLBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
#[doc = "Field `FIFOCONS` writer - FIFO Control"]
pub type FIFOCONS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
...
pub type RSTDTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_ISO_MODE_SPEC, bool, O>;
impl W {
