#[doc = "Writer for register SLPWK_DR0"]
pub type W = crate::W<u32, super::SLPWK_DR0>;
#[doc = "Register SLPWK_DR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SLPWK_DR0 {
    type Type = u32;
    #[inline(always)]
