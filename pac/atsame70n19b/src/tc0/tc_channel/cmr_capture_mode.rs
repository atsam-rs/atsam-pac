...
pub type TCCLKS_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, TCCLKSSELECT_A, 3, O>;
...
pub type CLKI_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, bool, O>;
...
pub type BURST_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, BURSTSELECT_A, 2, O>;
...
pub type LDBSTOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, bool, O>;
...
pub type LDBDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, bool, O>;
...
pub type ETRGEDG_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, ETRGEDGSELECT_A, 2, O>;
...
pub type ABETRG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, bool, O>;
...
pub type CPCTRG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, bool, O>;
#[doc = "Field `WAVE` reader - Waveform Mode"]
pub type WAVE_R = crate::BitReader<bool>;
#[doc = "Field `WAVE` writer - Waveform Mode"]
pub type WAVE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, bool, O>;
...
pub type LDRA_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, LDRASELECT_A, 2, O>;
...
pub type LDRB_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, LDRBSELECT_A, 2, O>;
...
pub type SBSMPLR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CMR_CAPTURE_MODE_SPEC, u8, SBSMPLRSELECT_A, 3, O>;
