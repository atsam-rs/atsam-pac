...
pub struct W(crate::W<PCIDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCIDR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<PCIDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCIDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DRDY` writer - Parallel Capture Mode Data Ready Interrupt Disable"]
pub type DRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCIDR_SPEC, bool, O>;
#[doc = "Field `OVRE` writer - Parallel Capture Mode Overrun Error Interrupt Disable"]
pub type OVRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCIDR_SPEC, bool, O>;
#[doc = "Field `ENDRX` writer - End of Reception Transfer Interrupt Disable"]
pub type ENDRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCIDR_SPEC, bool, O>;
#[doc = "Field `RXBUFF` writer - Reception Buffer Full Interrupt Disable"]
pub type RXBUFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, PCIDR_SPEC, bool, O>;
impl W {
