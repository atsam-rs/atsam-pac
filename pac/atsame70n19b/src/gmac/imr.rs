...
#[doc = "Reader of field `TSUTIMCOMP`"]
pub type TSUTIMCOMP_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TSUTIMCOMP`"]
pub struct TSUTIMCOMP_W<'a> {
    w: &'a mut W,
}
impl<'a> TSUTIMCOMP_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 29 - TSU Timer Comparison"]
    #[inline(always)]
    pub fn tsutimcomp(&mut self) -> TSUTIMCOMP_W {
        TSUTIMCOMP_W { w: self }
    }
}
