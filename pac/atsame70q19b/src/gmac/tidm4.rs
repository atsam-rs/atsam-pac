#[doc = "Reader of register TIDM4"]
pub type R = crate::R<u32, super::TIDM4>;
#[doc = "Writer for register TIDM4"]
pub type W = crate::W<u32, super::TIDM4>;
#[doc = "Register TIDM4 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIDM4 {
    type Type = u32;
    #[inline(always)]
