#[doc = "Reader of register TIDM1"]
pub type R = crate::R<u32, super::TIDM1>;
#[doc = "Writer for register TIDM1"]
pub type W = crate::W<u32, super::TIDM1>;
#[doc = "Register TIDM1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIDM1 {
    type Type = u32;
    #[inline(always)]
