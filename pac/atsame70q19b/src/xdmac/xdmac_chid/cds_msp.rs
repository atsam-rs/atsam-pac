#[doc = "Reader of register CDS_MSP"]
pub type R = crate::R<u32, super::CDS_MSP>;
#[doc = "Writer for register CDS_MSP"]
pub type W = crate::W<u32, super::CDS_MSP>;
#[doc = "Register CDS_MSP `reset()`'s with value 0"]
impl crate::ResetValue for super::CDS_MSP {
    type Type = u32;
    #[inline(always)]
