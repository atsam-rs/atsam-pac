...
pub struct W(crate::W<HSTPIPIFR_CTRL_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTPIPIFR_CTRL_MODE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<HSTPIPIFR_CTRL_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTPIPIFR_CTRL_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RXINIS` writer - Received IN Data Interrupt Set"]
pub type RXINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTIS` writer - Transmitted OUT Data Interrupt Set"]
pub type TXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `TXSTPIS` writer - Transmitted SETUP Interrupt Set"]
pub type TXSTPIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `PERRIS` writer - Pipe Error Interrupt Set"]
pub type PERRIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDIS` writer - NAKed Interrupt Set"]
pub type NAKEDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIS` writer - Overflow Interrupt Set"]
pub type OVERFIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTALLDIS` writer - Received STALLed Interrupt Set"]
pub type RXSTALLDIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
...
pub type NBUSYBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIFR_CTRL_MODE_SPEC, bool, O>;
impl W {
...
#[doc = "Host Pipe Set Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstpipifr_ctrl_mode](index.html) module"]
