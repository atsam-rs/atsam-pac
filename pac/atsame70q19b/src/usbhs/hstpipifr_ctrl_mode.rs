#[doc = "Writer for register HSTPIPIFR_CTRL_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIFR_CTRL_MODE>;
#[doc = "Register HSTPIPIFR_CTRL_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIFR_CTRL_MODE {
    type Type = u32;
    #[inline(always)]
