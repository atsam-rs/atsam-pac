...
pub struct W(crate::W<DEVEPTIDR_CTRL_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVEPTIDR_CTRL_MODE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<DEVEPTIDR_CTRL_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVEPTIDR_CTRL_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TXINEC` writer - Transmitted IN Interrupt Clear"]
pub type TXINEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTEC` writer - Received OUT Data Interrupt Clear"]
pub type RXOUTEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTPEC` writer - Received SETUP Interrupt Clear"]
pub type RXSTPEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKOUTEC` writer - NAKed OUT Interrupt Clear"]
pub type NAKOUTEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKINEC` writer - NAKed IN Interrupt Clear"]
pub type NAKINEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFEC` writer - Overflow Interrupt Clear"]
pub type OVERFEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `STALLEDEC` writer - STALLed Interrupt Clear"]
pub type STALLEDEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
...
pub type FIFOCONC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
...
pub type NYETDISC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `STALLRQC` writer - STALL Request Clear"]
pub type STALLRQC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_CTRL_MODE_SPEC, bool, O>;
impl W {
...
#[doc = "Device Endpoint Interrupt Disable Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [deveptidr_ctrl_mode](index.html) module"]
pub struct DEVEPTIDR_CTRL_MODE_SPEC;
impl crate::RegisterSpec for DEVEPTIDR_CTRL_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [deveptidr_ctrl_mode::W](W) writer structure"]
impl crate::Writable for DEVEPTIDR_CTRL_MODE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DEVEPTIDR_CTRL_MODE[%s]
to value 0"]
impl crate::Resettable for DEVEPTIDR_CTRL_MODE_SPEC {
