...
pub type RXINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTIC` writer - Transmitted OUT Data Interrupt Clear"]
pub type TXOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `TXSTPIC` writer - Transmitted SETUP Interrupt Clear"]
pub type TXSTPIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDIC` writer - NAKed Interrupt Clear"]
pub type NAKEDIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIC` writer - Overflow Interrupt Clear"]
pub type OVERFIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPICR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTALLDIC` writer - Received STALLed Interrupt Clear"]
pub type RXSTALLDIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPICR_BLK_MODE_SPEC, bool, O>;
