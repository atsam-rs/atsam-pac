#[doc = "Writer for register DEVEPTIFR_ISO_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIFR_ISO_MODE>;
#[doc = "Register DEVEPTIFR_ISO_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIFR_ISO_MODE {
    type Type = u32;
    #[inline(always)]
