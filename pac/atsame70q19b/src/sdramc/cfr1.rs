#[doc = "Reader of register CFR1"]
pub type R = crate::R<u32, super::CFR1>;
#[doc = "Writer for register CFR1"]
pub type W = crate::W<u32, super::CFR1>;
#[doc = "Register CFR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CFR1 {
    type Type = u32;
    #[inline(always)]
