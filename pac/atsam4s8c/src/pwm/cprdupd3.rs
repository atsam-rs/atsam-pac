...
pub struct W(crate::W<CPRDUPD3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPRDUPD3_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CPRDUPD3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPRDUPD3_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CPRDUPD` writer - Channel Period Update"]
pub type CPRDUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CPRDUPD3_SPEC, u32, u32, 24, O>;
impl W {
