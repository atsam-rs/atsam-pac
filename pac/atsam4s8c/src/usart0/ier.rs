...
impl W {
    ...
    #[doc = "Bit 11 - Transmit Buffer Empty Interrupt Enable (available in all USART modes of operation)"]
    #[inline(always)]
    pub fn txbufe(&mut self) -> TXBUFE_W {
        TXBUFE_W { w: self }
    }
    #[doc = "Bit 12 - Receive Buffer Full Interrupt Enable (available in all USART modes of operation)"]
    #[inline(always)]
