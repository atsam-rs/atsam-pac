# Microchip/Atmel ATSAM4S8C PAC for Rust

This repository holds the Peripheral Access Crate for the Atmel `ATSAM4S8C` microcontroller.

[![Docs](https://docs.rs/atsam4s8c-pac/badge.svg)](https://docs.rs/atsam4s8c-pac/latest/)
