# Microchip/Atmel ATSAM4S2C PAC for Rust

This repository holds the Peripheral Access Crate for the Atmel `ATSAM4S2C` microcontroller.

[![Docs](https://docs.rs/atsam4s2c-pac/badge.svg)](https://docs.rs/atsam4s2c-pac/latest/)
