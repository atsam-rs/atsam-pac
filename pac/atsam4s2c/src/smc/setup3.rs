...
pub struct R(crate::R<SETUP3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SETUP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SETUP3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SETUP3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SETUP3` writer"]
pub struct W(crate::W<SETUP3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SETUP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SETUP3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SETUP3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP3_SPEC, u8, u8, 6, O>;
...
pub type NCS_WR_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP3_SPEC, u8, u8, 6, O>;
...
pub type NRD_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP3_SPEC, u8, u8, 6, O>;
...
pub type NCS_RD_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP3_SPEC, u8, u8, 6, O>;
impl R {
