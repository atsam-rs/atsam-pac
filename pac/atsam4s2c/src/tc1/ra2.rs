...
pub struct R(crate::R<RA2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RA2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RA2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RA2` writer"]
pub struct W(crate::W<RA2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RA2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RA2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RA2_SPEC, u32, u32, 32, O>;
impl R {
