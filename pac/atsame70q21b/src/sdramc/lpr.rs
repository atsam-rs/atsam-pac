...
pub type LPCB_R = crate::FieldReader<u8, LPCBSELECT_A>;
#[doc = "Low-power Configuration Bits\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum LPCBSELECT_A {
...
impl From<LPCBSELECT_A> for u8 {
    #[inline(always)]
    fn from(variant: LPCBSELECT_A) -> Self {
        variant as _
    }
}
impl LPCB_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> LPCBSELECT_A {
        match self.bits {
            0 => LPCBSELECT_A::DISABLED,
            1 => LPCBSELECT_A::SELF_REFRESH,
            2 => LPCBSELECT_A::POWER_DOWN,
            3 => LPCBSELECT_A::DEEP_POWER_DOWN,
            _ => unreachable!(),
        }
    }
...
impl<'a, const O: u8> LPCB_W<'a, O> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(LPCBSELECT_A::DISABLED)
    }
    ...
    pub fn self_refresh(self) -> &'a mut W {
        self.variant(LPCBSELECT_A::SELF_REFRESH)
    }
    ...
    pub fn power_down(self) -> &'a mut W {
        self.variant(LPCBSELECT_A::POWER_DOWN)
    }
    ...
    pub fn deep_power_down(self) -> &'a mut W {
        self.variant(LPCBSELECT_A::DEEP_POWER_DOWN)
    }
}
...
pub type TIMEOUT_R = crate::FieldReader<u8, TIMEOUTSELECT_A>;
...
impl From<TIMEOUTSELECT_A> for u8 {
    #[inline(always)]
...
impl TIMEOUT_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<TIMEOUTSELECT_A> {
        match self.bits {
            0 => Some(TIMEOUTSELECT_A::LP_LAST_XFER),
            1 => Some(TIMEOUTSELECT_A::LP_LAST_XFER_64),
            2 => Some(TIMEOUTSELECT_A::LP_LAST_XFER_128),
            _ => None,
        }
    }
...
impl<'a, const O: u8> TIMEOUT_W<'a, O> {
    ...
    pub fn lp_last_xfer(self) -> &'a mut W {
        self.variant(TIMEOUTSELECT_A::LP_LAST_XFER)
    }
    ...
    pub fn lp_last_xfer_64(self) -> &'a mut W {
        self.variant(TIMEOUTSELECT_A::LP_LAST_XFER_64)
    }
    ...
    pub fn lp_last_xfer_128(self) -> &'a mut W {
        self.variant(TIMEOUTSELECT_A::LP_LAST_XFER_128)
    }
}
impl R {
