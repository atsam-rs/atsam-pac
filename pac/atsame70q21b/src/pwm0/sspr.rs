#[doc = "Reader of register SSPR"]
pub type R = crate::R<u32, super::SSPR>;
#[doc = "Writer for register SSPR"]
pub type W = crate::W<u32, super::SSPR>;
#[doc = "Register SSPR `reset()`'s with value 0"]
impl crate::ResetValue for super::SSPR {
    type Type = u32;
    #[inline(always)]
