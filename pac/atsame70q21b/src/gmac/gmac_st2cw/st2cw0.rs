...
pub type MASKVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST2CW0_SPEC, u16, u16, 16, O>;
#[doc = "Field `COMPVAL` reader - Compare Value"]
pub type COMPVAL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `COMPVAL` writer - Compare Value"]
pub type COMPVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ST2CW0_SPEC, u16, u16, 16, O>;
impl R {
