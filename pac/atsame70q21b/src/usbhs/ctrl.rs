...
pub type RDERRE_R = crate::BitReader<bool>;
#[doc = "Field `RDERRE` writer - Remote Device Connection Error Interrupt Enable"]
pub type RDERRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type UID_R = crate::BitReader<bool>;
#[doc = "Field `UID` writer - UID Pin Enable"]
pub type UID_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type UIMOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, UIMODSELECT_A, O>;
