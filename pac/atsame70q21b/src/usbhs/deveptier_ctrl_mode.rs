#[doc = "Writer for register DEVEPTIER_CTRL_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIER_CTRL_MODE>;
#[doc = "Register DEVEPTIER_CTRL_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIER_CTRL_MODE {
    type Type = u32;
    #[inline(always)]
