...
pub struct W(crate::W<DEVEPTIFR_CTRL_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVEPTIFR_CTRL_MODE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<DEVEPTIFR_CTRL_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVEPTIFR_CTRL_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TXINIS` writer - Transmitted IN Data Interrupt Set"]
pub type TXINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTIS` writer - Received OUT Data Interrupt Set"]
pub type RXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTPIS` writer - Received SETUP Interrupt Set"]
pub type RXSTPIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKOUTIS` writer - NAKed OUT Interrupt Set"]
pub type NAKOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKINIS` writer - NAKed IN Interrupt Set"]
pub type NAKINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIS` writer - Overflow Interrupt Set"]
pub type OVERFIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `STALLEDIS` writer - STALLed Interrupt Set"]
pub type STALLEDIS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
...
pub type NBUSYBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIFR_CTRL_MODE_SPEC, bool, O>;
impl W {
...
#[doc = "Device Endpoint Interrupt Set Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [deveptifr_ctrl_mode](index.html) module"]
pub struct DEVEPTIFR_CTRL_MODE_SPEC;
impl crate::RegisterSpec for DEVEPTIFR_CTRL_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [deveptifr_ctrl_mode::W](W) writer structure"]
impl crate::Writable for DEVEPTIFR_CTRL_MODE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DEVEPTIFR_CTRL_MODE[%s]
to value 0"]
impl crate::Resettable for DEVEPTIFR_CTRL_MODE_SPEC {
