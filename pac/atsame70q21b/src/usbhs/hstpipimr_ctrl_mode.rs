...
pub struct R(crate::R<HSTPIPIMR_CTRL_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HSTPIPIMR_CTRL_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HSTPIPIMR_CTRL_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HSTPIPIMR_CTRL_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Host Pipe Mask Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstpipimr_ctrl_mode](index.html) module"]
