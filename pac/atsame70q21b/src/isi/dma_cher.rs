#[doc = "Writer for register DMA_CHER"]
pub type W = crate::W<u32, super::DMA_CHER>;
#[doc = "Register DMA_CHER `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_CHER {
    type Type = u32;
    #[inline(always)]
