...
pub type DUALBUFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, MR_SPEC, DUALBUFFSELECT_A, O>;
...
pub type SMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MR_SPEC, u8, SMODSELECT_A, 2, O>;
...
pub type KEYSIZE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MR_SPEC, u8, KEYSIZESELECT_A, 2, O>;
...
pub type OPMOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MR_SPEC, u8, OPMODSELECT_A, 3, O>;
...
pub type CFBS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MR_SPEC, u8, CFBSSELECT_A, 3, O>;
...
pub type CKEY_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MR_SPEC, u8, CKEYSELECT_A, 4, O>;
