#[doc = "Writer for register SLPWK_ER1"]
pub type W = crate::W<u32, super::SLPWK_ER1>;
#[doc = "Register SLPWK_ER1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SLPWK_ER1 {
    type Type = u32;
    #[inline(always)]
