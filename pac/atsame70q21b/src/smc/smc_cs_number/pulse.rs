#[doc = "Reader of register PULSE"]
pub type R = crate::R<u32, super::PULSE>;
#[doc = "Writer for register PULSE"]
pub type W = crate::W<u32, super::PULSE>;
#[doc = "Register PULSE `reset()`'s with value 0"]
impl crate::ResetValue for super::PULSE {
    type Type = u32;
    #[inline(always)]
