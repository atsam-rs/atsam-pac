#[doc = "Reader of register CYCLE"]
pub type R = crate::R<u32, super::CYCLE>;
#[doc = "Writer for register CYCLE"]
pub type W = crate::W<u32, super::CYCLE>;
#[doc = "Register CYCLE `reset()`'s with value 0"]
impl crate::ResetValue for super::CYCLE {
    type Type = u32;
    #[inline(always)]
