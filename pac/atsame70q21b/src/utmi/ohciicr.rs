...
pub type RES0_W<'a, const O: u8> = crate::BitWriter<'a, u32, OHCIICR_SPEC, bool, O>;
#[doc = "Field `ARIE` reader - OHCI Asynchronous Resume Interrupt Enable"]
pub type ARIE_R = crate::BitReader<bool>;
#[doc = "Field `ARIE` writer - OHCI Asynchronous Resume Interrupt Enable"]
pub type ARIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, OHCIICR_SPEC, bool, O>;
#[doc = "Field `APPSTART` reader - "]
pub type APPSTART_R = crate::BitReader<bool>;
#[doc = "Field `APPSTART` writer - "]
pub type APPSTART_W<'a, const O: u8> = crate::BitWriter<'a, u32, OHCIICR_SPEC, bool, O>;
#[doc = "Field `UDPPUDIS` reader - USB Device Pull-up Disable"]
pub type UDPPUDIS_R = crate::BitReader<bool>;
#[doc = "Field `UDPPUDIS` writer - USB Device Pull-up Disable"]
pub type UDPPUDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, OHCIICR_SPEC, bool, O>;
impl R {
