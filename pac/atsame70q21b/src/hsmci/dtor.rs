...
pub type DTOCYC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DTOR_SPEC, u8, u8, 4, O>;
...
pub type DTOMUL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, DTOR_SPEC, u8, DTOMULSELECT_A, 3, O>;
