...
pub type RXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `TXRDY` writer - TXRDY Interrupt Disable"]
pub type TXRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `OVRE` writer - Overrun Error Interrupt Enable"]
pub type OVRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `FRAME` writer - Framing Error Interrupt Disable"]
pub type FRAME_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `PARE` writer - Parity Error Interrupt Disable"]
pub type PARE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `TIMEOUT` writer - Timeout Interrupt Disable"]
pub type TIMEOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `TXEMPTY` writer - TXEMPTY Interrupt Disable"]
pub type TXEMPTY_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINBK` writer - LIN Break Sent or LIN Break Received Interrupt Disable"]
pub type LINBK_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINID` writer - LIN Identifier Sent or LIN Identifier Received Interrupt Disable"]
pub type LINID_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINTC` writer - LIN Transfer Completed Interrupt Disable"]
pub type LINTC_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINBE` writer - LIN Bus Error Interrupt Disable"]
pub type LINBE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINISFE` writer - LIN Inconsistent Synch Field Error Interrupt Disable"]
pub type LINISFE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINIPE` writer - LIN Identifier Parity Interrupt Disable"]
pub type LINIPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINCE` writer - LIN Checksum Error Interrupt Disable"]
pub type LINCE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINSNRE` writer - LIN Slave Not Responding Error Interrupt Disable"]
pub type LINSNRE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINSTE` writer - LIN Synch Tolerance Error Interrupt Disable"]
pub type LINSTE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
#[doc = "Field `LINHTE` writer - LIN Header Timeout Error Interrupt Disable"]
pub type LINHTE_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_IDR_LIN_MODE_SPEC, bool, O>;
impl W {
