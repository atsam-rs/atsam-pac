#[doc = "Reader of register AADLENR"]
pub type R = crate::R<u32, super::AADLENR>;
#[doc = "Writer for register AADLENR"]
pub type W = crate::W<u32, super::AADLENR>;
#[doc = "Register AADLENR `reset()`'s with value 0"]
impl crate::ResetValue for super::AADLENR {
    type Type = u32;
    #[inline(always)]
