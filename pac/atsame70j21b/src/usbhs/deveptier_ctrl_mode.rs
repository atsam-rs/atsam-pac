...
pub struct W(crate::W<DEVEPTIER_CTRL_MODE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEVEPTIER_CTRL_MODE_SPEC>;
    #[inline(always)]
...
impl From<crate::W<DEVEPTIER_CTRL_MODE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEVEPTIER_CTRL_MODE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TXINES` writer - Transmitted IN Data Interrupt Enable"]
pub type TXINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTES` writer - Received OUT Data Interrupt Enable"]
pub type RXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTPES` writer - Received SETUP Interrupt Enable"]
pub type RXSTPES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKOUTES` writer - NAKed OUT Interrupt Enable"]
pub type NAKOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKINES` writer - NAKed IN Interrupt Enable"]
pub type NAKINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFES` writer - Overflow Interrupt Enable"]
pub type OVERFES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `STALLEDES` writer - STALLed Interrupt Enable"]
pub type STALLEDES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
...
pub type KILLBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `FIFOCONS` writer - FIFO Control"]
pub type FIFOCONS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
...
pub type NYETDISS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RSTDTS` writer - Reset Data Toggle Enable"]
pub type RSTDTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `STALLRQS` writer - STALL Request Enable"]
pub type STALLRQS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_CTRL_MODE_SPEC, bool, O>;
impl W {
...
#[doc = "Device Endpoint Interrupt Enable Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [deveptier_ctrl_mode](index.html) module"]
pub struct DEVEPTIER_CTRL_MODE_SPEC;
impl crate::RegisterSpec for DEVEPTIER_CTRL_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [deveptier_ctrl_mode::W](W) writer structure"]
impl crate::Writable for DEVEPTIER_CTRL_MODE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DEVEPTIER_CTRL_MODE[%s]
to value 0"]
impl crate::Resettable for DEVEPTIER_CTRL_MODE_SPEC {
