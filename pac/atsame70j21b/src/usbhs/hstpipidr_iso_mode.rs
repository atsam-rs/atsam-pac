#[doc = "Writer for register HSTPIPIDR_ISO_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIDR_ISO_MODE>;
#[doc = "Register HSTPIPIDR_ISO_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIDR_ISO_MODE {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `CRCERREC`"]
pub struct CRCERREC_W<'a> {
    w: &'a mut W,
}
impl<'a> CRCERREC_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[inline(always)]
    pub fn crcerrec(&mut self) -> CRCERREC_W {
        CRCERREC_W { w: self }
    }
