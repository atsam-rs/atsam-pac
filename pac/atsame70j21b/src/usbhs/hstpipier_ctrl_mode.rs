...
pub type RXINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `TXOUTES` writer - Transmitted OUT Data Interrupt Enable"]
pub type TXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `TXSTPES` writer - Transmitted SETUP Interrupt Enable"]
pub type TXSTPES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `PERRES` writer - Pipe Error Interrupt Enable"]
pub type PERRES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `NAKEDES` writer - NAKed Interrupt Enable"]
pub type NAKEDES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFIES` writer - Overflow Interrupt Enable"]
pub type OVERFIES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTALLDES` writer - Received STALLed Interrupt Enable"]
pub type RXSTALLDES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
...
pub type PFREEZES_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
#[doc = "Field `RSTDTS` writer - Reset Data Toggle Enable"]
pub type RSTDTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, HSTPIPIER_CTRL_MODE_SPEC, bool, O>;
impl W {
