#[doc = "Register `DEVEPTIMR_CTRL_MODE[%s]` reader"]
pub struct R(crate::R<DEVEPTIMR_CTRL_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEVEPTIMR_CTRL_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEVEPTIMR_CTRL_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEVEPTIMR_CTRL_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Device Endpoint Interrupt Mask Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [deveptimr_ctrl_mode](index.html) module"]
pub struct DEVEPTIMR_CTRL_MODE_SPEC;
impl crate::RegisterSpec for DEVEPTIMR_CTRL_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [deveptimr_ctrl_mode::R](R) reader structure"]
impl crate::Readable for DEVEPTIMR_CTRL_MODE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DEVEPTIMR_CTRL_MODE[%s]
to value 0"]
impl crate::Resettable for DEVEPTIMR_CTRL_MODE_SPEC {
    #[inline(always)]
