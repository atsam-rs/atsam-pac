#[doc = "Writer for register HSTPIPIER_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIER_INTRPT_MODE>;
#[doc = "Register HSTPIPIER_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIER_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
