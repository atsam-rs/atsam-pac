...
pub type TID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIDM3_SPEC, u16, u16, 16, O>;
#[doc = "Field `ENID3` reader - Enable Copying of TID Matched Frames"]
pub type ENID3_R = crate::BitReader<bool>;
#[doc = "Field `ENID3` writer - Enable Copying of TID Matched Frames"]
pub type ENID3_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIDM3_SPEC, bool, O>;
impl R {
