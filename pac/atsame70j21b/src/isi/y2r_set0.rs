...
pub type C0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `C0` writer - Color Space Conversion Matrix Coefficient C0"]
pub type C0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, Y2R_SET0_SPEC, u8, u8, 8, O>;
...
pub type C1_W<'a, const O: u8> = crate::FieldWriter<'a, u32, Y2R_SET0_SPEC, u8, u8, 8, O>;
...
pub type C2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, Y2R_SET0_SPEC, u8, u8, 8, O>;
...
pub type C3_W<'a, const O: u8> = crate::FieldWriter<'a, u32, Y2R_SET0_SPEC, u8, u8, 8, O>;
impl R {
