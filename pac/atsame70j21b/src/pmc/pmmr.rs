#[doc = "Reader of register PMMR"]
pub type R = crate::R<u32, super::PMMR>;
#[doc = "Writer for register PMMR"]
pub type W = crate::W<u32, super::PMMR>;
#[doc = "Register PMMR `reset()`'s with value 0"]
impl crate::ResetValue for super::PMMR {
    type Type = u32;
    #[inline(always)]
