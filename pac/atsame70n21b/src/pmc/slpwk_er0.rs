#[doc = "Writer for register SLPWK_ER0"]
pub type W = crate::W<u32, super::SLPWK_ER0>;
#[doc = "Register SLPWK_ER0 `reset()`'s with value 0"]
impl crate::ResetValue for super::SLPWK_ER0 {
    type Type = u32;
    #[inline(always)]
