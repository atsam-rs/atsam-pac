#[doc = "Reader of register FSMR"]
pub type R = crate::R<u32, super::FSMR>;
#[doc = "Writer for register FSMR"]
pub type W = crate::W<u32, super::FSMR>;
#[doc = "Register FSMR `reset()`'s with value 0"]
impl crate::ResetValue for super::FSMR {
    type Type = u32;
    #[inline(always)]
