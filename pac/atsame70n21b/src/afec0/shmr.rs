#[doc = "Reader of register SHMR"]
pub type R = crate::R<u32, super::SHMR>;
#[doc = "Writer for register SHMR"]
pub type W = crate::W<u32, super::SHMR>;
#[doc = "Register SHMR `reset()`'s with value 0"]
impl crate::ResetValue for super::SHMR {
    type Type = u32;
    #[inline(always)]
