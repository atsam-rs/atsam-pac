#[doc = "Writer for register DEVEPTIDR_INTRPT_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIDR_INTRPT_MODE>;
#[doc = "Register DEVEPTIDR_INTRPT_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIDR_INTRPT_MODE {
    type Type = u32;
    #[inline(always)]
