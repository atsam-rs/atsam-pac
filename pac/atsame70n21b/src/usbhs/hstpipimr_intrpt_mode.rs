#[doc = "Reader of register HSTPIPIMR_INTRPT_MODE[%s]"]
pub type R = crate::R<u32, super::HSTPIPIMR_INTRPT_MODE>;
#[doc = "Reader of field `RXINE`"]
pub type RXINE_R = crate::R<bool, bool>;
#[doc = "Reader of field `TXOUTE`"]
pub type TXOUTE_R = crate::R<bool, bool>;
#[doc = "Reader of field `UNDERFIE`"]
pub type UNDERFIE_R = crate::R<bool, bool>;
