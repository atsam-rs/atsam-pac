#[doc = "Reader of register HSTDMANXTDSC"]
pub type R = crate::R<u32, super::HSTDMANXTDSC>;
#[doc = "Writer for register HSTDMANXTDSC"]
pub type W = crate::W<u32, super::HSTDMANXTDSC>;
#[doc = "Register HSTDMANXTDSC `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMANXTDSC {
    type Type = u32;
    #[inline(always)]
