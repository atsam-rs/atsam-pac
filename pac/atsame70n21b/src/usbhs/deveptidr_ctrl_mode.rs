#[doc = "Writer for register DEVEPTIDR_CTRL_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIDR_CTRL_MODE>;
#[doc = "Register DEVEPTIDR_CTRL_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIDR_CTRL_MODE {
    type Type = u32;
    #[inline(always)]
