...
pub type MAXCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ETRG1_SPEC, u32, u32, 24, O>;
...
pub type TRGMODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, ETRG1_SPEC, u8, TRGMODESELECT_A, 2, O>;
...
pub type TRGEDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETRG1_SPEC, TRGEDGESELECT_A, O>;
...
pub type TRGFILT_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETRG1_SPEC, bool, O>;
#[doc = "Field `TRGSRC` reader - Trigger Source"]
pub type TRGSRC_R = crate::BitReader<bool>;
#[doc = "Field `TRGSRC` writer - Trigger Source"]
pub type TRGSRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETRG1_SPEC, bool, O>;
...
pub type RFEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ETRG1_SPEC, bool, O>;
impl R {
