#[doc = "Reader of register ST2CW0"]
pub type R = crate::R<u32, super::ST2CW0>;
#[doc = "Writer for register ST2CW0"]
pub type W = crate::W<u32, super::ST2CW0>;
#[doc = "Register ST2CW0 `reset()`'s with value 0"]
impl crate::ResetValue for super::ST2CW0 {
    type Type = u32;
    #[inline(always)]
