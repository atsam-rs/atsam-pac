#[doc = "Writer for register UPSTA0SET"]
pub type W = crate::W<u32, super::UPSTA0SET>;
#[doc = "Register UPSTA0SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA0SET {
    type Type = u32;
    #[inline(always)]
