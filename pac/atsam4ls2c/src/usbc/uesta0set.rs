#[doc = "Writer for register UESTA0SET"]
pub type W = crate::W<u32, super::UESTA0SET>;
#[doc = "Register UESTA0SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA0SET {
    type Type = u32;
    #[inline(always)]
