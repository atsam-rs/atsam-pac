#[doc = "Writer for register UPCON6SET"]
pub type W = crate::W<u32, super::UPCON6SET>;
#[doc = "Register UPCON6SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON6SET {
    type Type = u32;
    #[inline(always)]
