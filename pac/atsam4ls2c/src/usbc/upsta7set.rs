#[doc = "Writer for register UPSTA7SET"]
pub type W = crate::W<u32, super::UPSTA7SET>;
#[doc = "Register UPSTA7SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA7SET {
    type Type = u32;
    #[inline(always)]
