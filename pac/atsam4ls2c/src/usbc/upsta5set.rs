#[doc = "Writer for register UPSTA5SET"]
pub type W = crate::W<u32, super::UPSTA5SET>;
#[doc = "Register UPSTA5SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA5SET {
    type Type = u32;
    #[inline(always)]
