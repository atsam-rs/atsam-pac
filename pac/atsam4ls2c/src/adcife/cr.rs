...
#[doc = "Write proxy for field `REFBUFDIS`"]
pub struct REFBUFDIS_W<'a> {
    w: &'a mut W,
}
impl<'a> REFBUFDIS_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Write proxy for field `BGREQEN`"]
pub struct BGREQEN_W<'a> {
    w: &'a mut W,
}
impl<'a> BGREQEN_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `BGREQDIS`"]
pub struct BGREQDIS_W<'a> {
    w: &'a mut W,
}
impl<'a> BGREQDIS_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[inline(always)]
    pub fn refbufdis(&mut self) -> REFBUFDIS_W {
        REFBUFDIS_W { w: self }
    }
    ...
    #[inline(always)]
    pub fn bgreqen(&mut self) -> BGREQEN_W {
        BGREQEN_W { w: self }
    }
    #[doc = "Bit 11 - Bandgap buffer request disable"]
    #[inline(always)]
    pub fn bgreqdis(&mut self) -> BGREQDIS_W {
        BGREQDIS_W { w: self }
    }
}
