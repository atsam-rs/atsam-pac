#[doc = "Reader of register EDGE"]
pub type R = crate::R<u32, super::EDGE>;
#[doc = "Writer for register EDGE"]
pub type W = crate::W<u32, super::EDGE>;
#[doc = "Register EDGE `reset()`'s with value 0"]
impl crate::ResetValue for super::EDGE {
    type Type = u32;
    #[inline(always)]
