#[doc = "Reader of register ODCR1C%s"]
pub type R = crate::R<u32, super::ODCR1C>;
#[doc = "Writer for register ODCR1C%s"]
pub type W = crate::W<u32, super::ODCR1C>;
#[doc = "Register ODCR1C%s `reset()`'s with value 0"]
impl crate::ResetValue for super::ODCR1C {
    type Type = u32;
    #[inline(always)]
