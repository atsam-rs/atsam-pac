#[doc = "Reader of register GPER%s"]
pub type R = crate::R<u32, super::GPER>;
#[doc = "Writer for register GPER%s"]
pub type W = crate::W<u32, super::GPER>;
#[doc = "Register GPER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::GPER {
    type Type = u32;
    #[inline(always)]
