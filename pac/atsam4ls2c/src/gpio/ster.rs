#[doc = "Reader of register STER%s"]
pub type R = crate::R<u32, super::STER>;
#[doc = "Writer for register STER%s"]
pub type W = crate::W<u32, super::STER>;
#[doc = "Register STER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::STER {
    type Type = u32;
    #[inline(always)]
