...
pub type CVMUPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMPVUPD6_SPEC, bool, O>;
impl W {
...
#[doc = "PWM Comparison 6 Value Update Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpvupd6](index.html) module"]
pub struct CMPVUPD6_SPEC;
impl crate::RegisterSpec for CMPVUPD6_SPEC {
    type Ux = u32;
}
