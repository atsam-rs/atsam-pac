...
pub struct R(crate::R<CMPM3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMPM3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMPM3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMPM3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMPM3` writer"]
pub struct W(crate::W<CMPM3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMPM3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMPM3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMPM3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CPRCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPM3_SPEC, u8, u8, 4, O>;
...
pub type CUPR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPM3_SPEC, u8, u8, 4, O>;
...
pub type CUPRCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPM3_SPEC, u8, u8, 4, O>;
impl R {
