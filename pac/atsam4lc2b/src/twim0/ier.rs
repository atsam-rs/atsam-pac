...
pub type CRDY_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `CCOMP` writer - Command Complete"]
pub type CCOMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `IDLE` writer - Master Interface is Idle"]
pub type IDLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `BUSFREE` writer - Two-wire Bus is Free"]
pub type BUSFREE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `ANAK` writer - NAK in Address Phase Received"]
pub type ANAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `DNAK` writer - NAK in Data Phase Received"]
pub type DNAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
...
pub type SMBALERT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `TOUT` writer - Timeout"]
pub type TOUT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `PECERR` writer - PEC Error"]
pub type PECERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `STOP` writer - Stop Request Accepted"]
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `HSMCACK` writer - ACK in HS-mode Master Code Phase Received"]
pub type HSMCACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
impl W {
