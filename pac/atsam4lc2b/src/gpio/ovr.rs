#[doc = "Reader of register OVR%s"]
pub type R = crate::R<u32, super::OVR>;
#[doc = "Writer for register OVR%s"]
pub type W = crate::W<u32, super::OVR>;
#[doc = "Register OVR%s `reset()`'s with value 0"]
impl crate::ResetValue for super::OVR {
    type Type = u32;
    #[inline(always)]
