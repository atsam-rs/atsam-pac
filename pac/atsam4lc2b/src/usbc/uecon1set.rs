#[doc = "Writer for register UECON1SET"]
pub type W = crate::W<u32, super::UECON1SET>;
#[doc = "Register UECON1SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON1SET {
    type Type = u32;
    #[inline(always)]
