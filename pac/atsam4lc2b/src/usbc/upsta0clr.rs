#[doc = "Writer for register UPSTA0CLR"]
pub type W = crate::W<u32, super::UPSTA0CLR>;
#[doc = "Register UPSTA0CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA0CLR {
    type Type = u32;
    #[inline(always)]
