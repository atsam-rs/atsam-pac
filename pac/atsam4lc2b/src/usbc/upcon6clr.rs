#[doc = "Writer for register UPCON6CLR"]
pub type W = crate::W<u32, super::UPCON6CLR>;
#[doc = "Register UPCON6CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON6CLR {
    type Type = u32;
    #[inline(always)]
