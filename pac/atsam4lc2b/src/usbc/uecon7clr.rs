#[doc = "Writer for register UECON7CLR"]
pub type W = crate::W<u32, super::UECON7CLR>;
#[doc = "Register UECON7CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON7CLR {
    type Type = u32;
    #[inline(always)]
