#[doc = "Writer for register UPSTA4SET"]
pub type W = crate::W<u32, super::UPSTA4SET>;
#[doc = "Register UPSTA4SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA4SET {
    type Type = u32;
    #[inline(always)]
