...
impl From<crate::W<UECON3SET_SPEC>> for W {
    #[inline(always)]
...
pub type TXINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `RXOUTES` writer - RXOUTE Set"]
pub type RXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `RXSTPES` writer - RXSTPE Set"]
pub type RXSTPES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `NAKOUTES` writer - NAKOUTE Set"]
pub type NAKOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `NAKINES` writer - NAKINE Set"]
pub type NAKINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `STALLEDES` writer - STALLEDE Set"]
pub type STALLEDES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `NREPLYS` writer - NREPLY Set"]
pub type NREPLYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `RAMACERES` writer - RAMACERE Set"]
pub type RAMACERES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `NBUSYBKES` writer - NBUSYBKE Set"]
pub type NBUSYBKES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `KILLBKS` writer - KILLBK Set"]
pub type KILLBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `NYETDISS` writer - NYETDIS Set"]
pub type NYETDISS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `RSTDTS` writer - RSTDT Set"]
pub type RSTDTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `STALLRQS` writer - STALLRQ Set"]
pub type STALLRQS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `BUSY0S` writer - BUSY0 Set"]
pub type BUSY0S_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
#[doc = "Field `BUSY1S` writer - BUSY1 Set"]
pub type BUSY1S_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECON3SET_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - TXINE Set"]
    #[inline(always)]
    #[must_use]
