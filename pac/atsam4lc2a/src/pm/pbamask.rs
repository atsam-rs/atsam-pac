...
impl core::convert::From<crate::R<PBAMASK_SPEC>> for R {
...
impl core::convert::From<crate::W<PBAMASK_SPEC>> for W {
...
#[doc = "Field `LCDCA_` reader - LCDCA APB Clock Enable"]
pub struct LCDCA__R(crate::FieldReader<bool, bool>);
impl LCDCA__R {
    pub(crate) fn new(bits: bool) -> Self {
        LCDCA__R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LCDCA__R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `LCDCA_` writer - LCDCA APB Clock Enable"]
pub struct LCDCA__W<'a> {
    w: &'a mut W,
}
impl<'a> LCDCA__W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn lcdca_(&self) -> LCDCA__R {
        LCDCA__R::new(((self.bits >> 23) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - IISC APB Clock Enable"]
    ...
    #[doc = "Bit 23 - LCDCA APB Clock Enable"]
    #[inline(always)]
    pub fn lcdca_(&mut self) -> LCDCA__W {
        LCDCA__W { w: self }
    }
