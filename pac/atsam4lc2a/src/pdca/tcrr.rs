...
impl core::convert::From<crate::R<TCRR_SPEC>> for R {
...
impl core::convert::From<crate::W<TCRR_SPEC>> for W {
    fn from(writer: crate::W<TCRR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TCRV` reader - Transfer Counter Reload Value"]
pub struct TCRV_R(crate::FieldReader<u16, u16>);
impl TCRV_R {
    pub(crate) fn new(bits: u16) -> Self {
        TCRV_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TCRV_R {
