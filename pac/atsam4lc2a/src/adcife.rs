...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn cdma_alt(&self) -> &crate::Reg<cdma_alt::CDMA_ALT_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(24usize)
                as *const crate::Reg<cdma_alt::CDMA_ALT_SPEC>)
        }
    }
    #[doc = "0x18 - Configuration Direct Memory Access Register"]
    #[inline(always)]
    pub fn cdma(&self) -> &crate::Reg<cdma::CDMA_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(24usize)
                as *const crate::Reg<cdma::CDMA_SPEC>)
        }
    }
}
...
pub mod calib;
#[doc = "CDMA register accessor: an alias for `Reg<CDMA_SPEC>`"]
pub type CDMA = crate::Reg<cdma::CDMA_SPEC>;
#[doc = "Configuration Direct Memory Access Register"]
pub mod cdma;
#[doc = "CDMA_ALT register accessor: an alias for `Reg<CDMA_ALT_SPEC>`"]
pub type CDMA_ALT = crate::Reg<cdma_alt::CDMA_ALT_SPEC>;
#[doc = "Configuration Direct Memory Access Register"]
pub mod cdma_alt;
