...
impl core::convert::From<crate::R<DMA_SPEC>> for R {
...
impl core::convert::From<crate::W<DMA_SPEC>> for W {
    fn from(writer: crate::W<DMA_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DMA` reader - Direct Memory Access"]
pub struct DMA_R(crate::FieldReader<u32, u32>);
impl DMA_R {
...
#[doc = "Field `DMA` writer - Direct Memory Access"]
pub struct DMA_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_W<'a> {
...
impl R {
    #[doc = "Bits 0:31 - Direct Memory Access"]
    #[inline(always)]
    pub fn dma(&self) -> DMA_R {
        DMA_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - Direct Memory Access"]
