...
impl core::convert::From<crate::R<IGFDR_SPEC>> for R {
...
impl core::convert::From<crate::W<IGFDR_SPEC>> for W {
    fn from(writer: crate::W<IGFDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `IGFDR` reader - Input Glitch Filter Divider Register"]
pub struct IGFDR_R(crate::FieldReader<u8, u8>);
impl IGFDR_R {
    pub(crate) fn new(bits: u8) -> Self {
        IGFDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IGFDR_R {
