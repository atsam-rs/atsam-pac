#[doc = "Register `UECON7` reader"]
pub struct R(crate::R<UECON7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UECON7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UECON7_SPEC>> for R {
    fn from(reader: crate::R<UECON7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Endpoint Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uecon7](index.html) module"]
pub struct UECON7_SPEC;
impl crate::RegisterSpec for UECON7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uecon7::R](R) reader structure"]
impl crate::Readable for UECON7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UECON7 to value 0"]
impl crate::Resettable for UECON7_SPEC {
    #[inline(always)]
