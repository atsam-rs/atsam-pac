#[doc = "Register `UECON5` reader"]
pub struct R(crate::R<UECON5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UECON5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UECON5_SPEC>> for R {
    fn from(reader: crate::R<UECON5_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Endpoint Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uecon5](index.html) module"]
pub struct UECON5_SPEC;
impl crate::RegisterSpec for UECON5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uecon5::R](R) reader structure"]
impl crate::Readable for UECON5_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UECON5 to value 0"]
impl crate::Resettable for UECON5_SPEC {
    #[inline(always)]
