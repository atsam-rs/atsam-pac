#[doc = "Register `UECON0` reader"]
pub struct R(crate::R<UECON0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UECON0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UECON0_SPEC>> for R {
    fn from(reader: crate::R<UECON0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Endpoint Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uecon0](index.html) module"]
pub struct UECON0_SPEC;
impl crate::RegisterSpec for UECON0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uecon0::R](R) reader structure"]
impl crate::Readable for UECON0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UECON0 to value 0"]
impl crate::Resettable for UECON0_SPEC {
    #[inline(always)]
