#[doc = "Register `UECON6` reader"]
pub struct R(crate::R<UECON6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UECON6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UECON6_SPEC>> for R {
    fn from(reader: crate::R<UECON6_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Endpoint Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uecon6](index.html) module"]
pub struct UECON6_SPEC;
impl crate::RegisterSpec for UECON6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uecon6::R](R) reader structure"]
impl crate::Readable for UECON6_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UECON6 to value 0"]
impl crate::Resettable for UECON6_SPEC {
    #[inline(always)]
