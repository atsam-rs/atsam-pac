#[doc = "Register `UPSTA3` reader"]
pub struct R(crate::R<UPSTA3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPSTA3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UPSTA3_SPEC>> for R {
    fn from(reader: crate::R<UPSTA3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Pipe Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upsta3](index.html) module"]
pub struct UPSTA3_SPEC;
impl crate::RegisterSpec for UPSTA3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upsta3::R](R) reader structure"]
impl crate::Readable for UPSTA3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UPSTA3 to value 0"]
impl crate::Resettable for UPSTA3_SPEC {
    #[inline(always)]
