...
impl core::convert::From<crate::R<UDESC_SPEC>> for R {
...
impl core::convert::From<crate::W<UDESC_SPEC>> for W {
    fn from(writer: crate::W<UDESC_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `UDESCA` reader - USB Descriptor Address"]
pub struct UDESCA_R(crate::FieldReader<u32, u32>);
impl UDESCA_R {
    pub(crate) fn new(bits: u32) -> Self {
        UDESCA_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for UDESCA_R {
