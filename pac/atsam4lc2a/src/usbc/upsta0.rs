#[doc = "Register `UPSTA0` reader"]
pub struct R(crate::R<UPSTA0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPSTA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UPSTA0_SPEC>> for R {
    fn from(reader: crate::R<UPSTA0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Pipe Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upsta0](index.html) module"]
pub struct UPSTA0_SPEC;
impl crate::RegisterSpec for UPSTA0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upsta0::R](R) reader structure"]
impl crate::Readable for UPSTA0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UPSTA0 to value 0"]
impl crate::Resettable for UPSTA0_SPEC {
    #[inline(always)]
