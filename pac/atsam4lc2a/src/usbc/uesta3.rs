#[doc = "Register `UESTA3` reader"]
pub struct R(crate::R<UESTA3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UESTA3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UESTA3_SPEC>> for R {
    fn from(reader: crate::R<UESTA3_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Endpoint Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uesta3](index.html) module"]
pub struct UESTA3_SPEC;
impl crate::RegisterSpec for UESTA3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uesta3::R](R) reader structure"]
impl crate::Readable for UESTA3_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UESTA3 to value 0x0100"]
impl crate::Resettable for UESTA3_SPEC {
    #[inline(always)]
