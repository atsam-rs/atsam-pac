#[doc = "Register `UPCON0` reader"]
pub struct R(crate::R<UPCON0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPCON0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UPCON0_SPEC>> for R {
    fn from(reader: crate::R<UPCON0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Pipe Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upcon0](index.html) module"]
pub struct UPCON0_SPEC;
impl crate::RegisterSpec for UPCON0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upcon0::R](R) reader structure"]
impl crate::Readable for UPCON0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UPCON0 to value 0"]
impl crate::Resettable for UPCON0_SPEC {
    #[inline(always)]
