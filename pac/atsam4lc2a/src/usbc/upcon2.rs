#[doc = "Register `UPCON2` reader"]
pub struct R(crate::R<UPCON2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPCON2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UPCON2_SPEC>> for R {
    fn from(reader: crate::R<UPCON2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Pipe Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upcon2](index.html) module"]
pub struct UPCON2_SPEC;
impl crate::RegisterSpec for UPCON2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upcon2::R](R) reader structure"]
impl crate::Readable for UPCON2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UPCON2 to value 0"]
impl crate::Resettable for UPCON2_SPEC {
    #[inline(always)]
