#[doc = "Register `UPCON1` reader"]
pub struct R(crate::R<UPCON1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPCON1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UPCON1_SPEC>> for R {
    fn from(reader: crate::R<UPCON1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Pipe Control Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upcon1](index.html) module"]
pub struct UPCON1_SPEC;
impl crate::RegisterSpec for UPCON1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upcon1::R](R) reader structure"]
impl crate::Readable for UPCON1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UPCON1 to value 0"]
impl crate::Resettable for UPCON1_SPEC {
    #[inline(always)]
