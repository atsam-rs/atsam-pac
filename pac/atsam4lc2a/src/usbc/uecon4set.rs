#[doc = "Writer for register UECON4SET"]
pub type W = crate::W<u32, super::UECON4SET>;
#[doc = "Register UECON4SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON4SET {
    type Type = u32;
    #[inline(always)]
