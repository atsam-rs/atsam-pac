#[doc = "Register `UESTA2` reader"]
pub struct R(crate::R<UESTA2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UESTA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<UESTA2_SPEC>> for R {
    fn from(reader: crate::R<UESTA2_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct UESTA2_SPEC;
impl crate::RegisterSpec for UESTA2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uesta2::R](R) reader structure"]
impl crate::Readable for UESTA2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets UESTA2 to value 0x0100"]
impl crate::Resettable for UESTA2_SPEC {
    #[inline(always)]
