...
impl core::convert::From<crate::R<HSSRR_SPEC>> for R {
...
impl core::convert::From<crate::W<HSSRR_SPEC>> for W {
...
pub struct CLDRIVEH_R(crate::FieldReader<u8, u8>);
impl CLDRIVEH_R {
    pub(crate) fn new(bits: u8) -> Self {
        CLDRIVEH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CLDRIVEH_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
