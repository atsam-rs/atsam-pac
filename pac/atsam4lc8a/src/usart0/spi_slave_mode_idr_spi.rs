#[doc = "Register `IDR_SPI` writer"]
pub struct W(crate::W<SPI_SLAVE_MODE_IDR_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI_SLAVE_MODE_IDR_SPI_SPEC>;
    #[inline(always)]
...
impl From<crate::W<SPI_SLAVE_MODE_IDR_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI_SLAVE_MODE_IDR_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RXRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, RXRDYSELECT_AW, O>;
...
pub type TXRDY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, TXRDYSELECT_AW, O>;
...
pub type RXBRK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, RXBRKSELECT_AW, O>;
...
pub type OVRE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, OVRESELECT_AW, O>;
...
pub type FRAME_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, FRAMESELECT_AW, O>;
...
pub type PARE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, PARESELECT_AW, O>;
...
pub type TIMEOUT_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, TIMEOUTSELECT_AW, O>;
...
pub type TXEMPTY_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, TXEMPTYSELECT_AW, O>;
...
pub type UNRE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, UNRESELECT_AW, O>;
...
pub type TXBUFE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, TXBUFESELECT_AW, O>;
...
pub type RXBUFF_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, RXBUFFSELECT_AW, O>;
...
pub type NACK_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, NACKSELECT_AW, O>;
...
pub type RIIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, RIICSELECT_AW, O>;
...
pub type DSRIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, DSRICSELECT_AW, O>;
...
pub type DCDIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, DCDICSELECT_AW, O>;
...
pub type CTSIC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, SPI_SLAVE_MODE_IDR_SPI_SPEC, CTSICSELECT_AW, O>;
...
#[doc = "Interrupt Disable Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi_slave_mode_idr_spi](index.html) module"]
pub struct SPI_SLAVE_MODE_IDR_SPI_SPEC;
impl crate::RegisterSpec for SPI_SLAVE_MODE_IDR_SPI_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [spi_slave_mode_idr_spi::W](W) writer structure"]
impl crate::Writable for SPI_SLAVE_MODE_IDR_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets IDR_SPI to value 0"]
impl crate::Resettable for SPI_SLAVE_MODE_IDR_SPI_SPEC {
