#[doc = "Reader of register PMR1%s"]
pub type R = crate::R<u32, super::PMR1>;
#[doc = "Writer for register PMR1%s"]
pub type W = crate::W<u32, super::PMR1>;
#[doc = "Register PMR1%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PMR1 {
    type Type = u32;
    #[inline(always)]
