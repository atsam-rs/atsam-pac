#[doc = "Writer for register UPSTA2SET"]
pub type W = crate::W<u32, super::UPSTA2SET>;
#[doc = "Register UPSTA2SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA2SET {
    type Type = u32;
    #[inline(always)]
