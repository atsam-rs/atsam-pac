...
pub type TXINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
#[doc = "Field `RXOUTIC` writer - RXOUTI Clear"]
pub type RXOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
#[doc = "Field `RXSTPIC` writer - RXSTPI Clear"]
pub type RXSTPIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
#[doc = "Field `NAKOUTIC` writer - NAKOUTI Clear"]
pub type NAKOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
#[doc = "Field `NAKINIC` writer - NAKINI Clear"]
pub type NAKINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
#[doc = "Field `STALLEDIC` writer - STALLEDI Clear"]
pub type STALLEDIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
#[doc = "Field `RAMACERIC` writer - RAMACERI Clear"]
pub type RAMACERIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA4CLR_SPEC, bool, O>;
impl W {
