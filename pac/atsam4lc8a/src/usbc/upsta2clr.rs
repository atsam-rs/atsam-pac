#[doc = "Writer for register UPSTA2CLR"]
pub type W = crate::W<u32, super::UPSTA2CLR>;
#[doc = "Register UPSTA2CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA2CLR {
    type Type = u32;
    #[inline(always)]
