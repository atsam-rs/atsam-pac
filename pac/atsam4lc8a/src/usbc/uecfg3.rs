#[doc = "Register `UECFG3` reader"]
pub struct R(crate::R<UECFG3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UECFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UECFG3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UECFG3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UECFG3` writer"]
pub struct W(crate::W<UECFG3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UECFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UECFG3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UECFG3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EPBK_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECFG3_SPEC, EPBKSELECT_A, O>;
...
pub type EPSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UECFG3_SPEC, u8, EPSIZESELECT_A, 3, O>;
...
pub type EPDIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECFG3_SPEC, EPDIRSELECT_A, O>;
...
pub type EPTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UECFG3_SPEC, u8, EPTYPESELECT_A, 2, O>;
...
pub type REPNB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UECFG3_SPEC, u8, u8, 4, O>;
impl R {
...
pub struct UECFG3_SPEC;
impl crate::RegisterSpec for UECFG3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [uecfg3::R](R) reader structure"]
impl crate::Readable for UECFG3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uecfg3::W](W) writer structure"]
impl crate::Writable for UECFG3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UECFG3 to value 0"]
impl crate::Resettable for UECFG3_SPEC {
