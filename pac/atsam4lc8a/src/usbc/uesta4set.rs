#[doc = "Writer for register UESTA4SET"]
pub type W = crate::W<u32, super::UESTA4SET>;
#[doc = "Register UESTA4SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA4SET {
    type Type = u32;
    #[inline(always)]
