#[doc = "Writer for register UESTA2SET"]
pub type W = crate::W<u32, super::UESTA2SET>;
#[doc = "Register UESTA2SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA2SET {
    type Type = u32;
    #[inline(always)]
