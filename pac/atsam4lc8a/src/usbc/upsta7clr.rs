...
impl From<crate::W<UPSTA7CLR_SPEC>> for W {
    #[inline(always)]
...
pub type RXINIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `TXOUTIC` writer - TXOUTI Clear"]
pub type TXOUTIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `TXSTPIC` writer - TXSTPI Clear"]
pub type TXSTPIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `PERRIC` writer - PERRI Clear"]
pub type PERRIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `NAKEDIC` writer - NAKEDI Clear"]
pub type NAKEDIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `ERRORFIC` writer - ERRORFI Clear"]
pub type ERRORFIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `RXSTALLDIC` writer - RXSTALLDI Clear"]
pub type RXSTALLDIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
#[doc = "Field `RAMACERIC` writer - RAMACERI Clear"]
pub type RAMACERIC_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA7CLR_SPEC, bool, O>;
impl W {
