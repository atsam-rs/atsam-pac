#[doc = "Writer for register UECON4CLR"]
pub type W = crate::W<u32, super::UECON4CLR>;
#[doc = "Register UECON4CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON4CLR {
    type Type = u32;
    #[inline(always)]
