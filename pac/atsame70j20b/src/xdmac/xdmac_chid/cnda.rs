#[doc = "Reader of register CNDA"]
pub type R = crate::R<u32, super::CNDA>;
#[doc = "Writer for register CNDA"]
pub type W = crate::W<u32, super::CNDA>;
#[doc = "Register CNDA `reset()`'s with value 0"]
impl crate::ResetValue for super::CNDA {
    type Type = u32;
    #[inline(always)]
