#[doc = "Writer for register DEVEPTIER_BLK_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTIER_BLK_MODE>;
#[doc = "Register DEVEPTIER_BLK_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTIER_BLK_MODE {
    type Type = u32;
    #[inline(always)]
