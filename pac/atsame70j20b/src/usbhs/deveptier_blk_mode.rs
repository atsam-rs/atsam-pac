...
pub type TXINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTES` writer - Received OUT Data Interrupt Enable"]
pub type RXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTPES` writer - Received SETUP Interrupt Enable"]
pub type RXSTPES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NAKOUTES` writer - NAKed OUT Interrupt Enable"]
pub type NAKOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NAKINES` writer - NAKed IN Interrupt Enable"]
pub type NAKINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFES` writer - Overflow Interrupt Enable"]
pub type OVERFES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `STALLEDES` writer - STALLed Interrupt Enable"]
pub type STALLEDES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `SHORTPACKETES` writer - Short Packet Interrupt Enable"]
pub type SHORTPACKETES_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NBUSYBKES` writer - Number of Busy Banks Interrupt Enable"]
pub type NBUSYBKES_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `KILLBKS` writer - Kill IN Bank"]
pub type KILLBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `FIFOCONS` writer - FIFO Control"]
pub type FIFOCONS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
...
pub type NYETDISS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RSTDTS` writer - Reset Data Toggle Enable"]
pub type RSTDTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `STALLRQS` writer - STALL Request Enable"]
pub type STALLRQS_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIER_BLK_MODE_SPEC, bool, O>;
impl W {
