#[doc = "Register `DEVEPTISR_INTRPT_MODE[%s]` reader"]
pub struct R(crate::R<DEVEPTISR_INTRPT_MODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEVEPTISR_INTRPT_MODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEVEPTISR_INTRPT_MODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEVEPTISR_INTRPT_MODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Device Endpoint Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [deveptisr_intrpt_mode](index.html) module"]
pub struct DEVEPTISR_INTRPT_MODE_SPEC;
impl crate::RegisterSpec for DEVEPTISR_INTRPT_MODE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [deveptisr_intrpt_mode::R](R) reader structure"]
impl crate::Readable for DEVEPTISR_INTRPT_MODE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DEVEPTISR_INTRPT_MODE[%s]
to value 0"]
impl crate::Resettable for DEVEPTISR_INTRPT_MODE_SPEC {
    #[inline(always)]
