...
pub type TXINEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RXOUTEC` writer - Received OUT Data Interrupt Clear"]
pub type RXOUTEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `RXSTPEC` writer - Received SETUP Interrupt Clear"]
pub type RXSTPEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NAKOUTEC` writer - NAKed OUT Interrupt Clear"]
pub type NAKOUTEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NAKINEC` writer - NAKed IN Interrupt Clear"]
pub type NAKINEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `OVERFEC` writer - Overflow Interrupt Clear"]
pub type OVERFEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `STALLEDEC` writer - STALLed Interrupt Clear"]
pub type STALLEDEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `SHORTPACKETEC` writer - Shortpacket Interrupt Clear"]
pub type SHORTPACKETEC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `NBUSYBKEC` writer - Number of Busy Banks Interrupt Clear"]
pub type NBUSYBKEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `FIFOCONC` writer - FIFO Control Clear"]
pub type FIFOCONC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
...
pub type NYETDISC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
#[doc = "Field `STALLRQC` writer - STALL Request Clear"]
pub type STALLRQC_W<'a, const O: u8> = crate::BitWriter<'a, u32, DEVEPTIDR_BLK_MODE_SPEC, bool, O>;
impl W {
