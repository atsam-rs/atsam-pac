#[doc = "Writer for register DEVEPTICR_ISO_MODE[%s]"]
pub type W = crate::W<u32, super::DEVEPTICR_ISO_MODE>;
#[doc = "Register DEVEPTICR_ISO_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::DEVEPTICR_ISO_MODE {
    type Type = u32;
    #[inline(always)]
