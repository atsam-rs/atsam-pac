...
pub type DIS_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `SRST` writer - Software Reset Interrupt Enable"]
pub type SRST_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `VSYNC` writer - Vertical Synchronization Interrupt Enable"]
pub type VSYNC_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `PXFR_DONE` writer - Preview DMA Transfer Done Interrupt Enable"]
pub type PXFR_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `CXFR_DONE` writer - Codec DMA Transfer Done Interrupt Enable"]
pub type CXFR_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `P_OVR` writer - Preview Datapath Overflow Interrupt Enable"]
pub type P_OVR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `C_OVR` writer - Codec Datapath Overflow Interrupt Enable"]
pub type C_OVR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `CRC_ERR` writer - Embedded Synchronization CRC Error Interrupt Enable"]
pub type CRC_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
#[doc = "Field `FR_OVR` writer - Frame Rate Overflow Interrupt Enable"]
pub type FR_OVR_W<'a, const O: u8> = crate::BitWriter<'a, u32, IER_SPEC, bool, O>;
impl W {
