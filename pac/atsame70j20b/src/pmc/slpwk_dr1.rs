#[doc = "Writer for register SLPWK_DR1"]
pub type W = crate::W<u32, super::SLPWK_DR1>;
#[doc = "Register SLPWK_DR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SLPWK_DR1 {
    type Type = u32;
    #[inline(always)]
