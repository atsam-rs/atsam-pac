...
impl URAT_R {
    ...
    pub fn variant(&self) -> Option<URATSELECT_A> {
        match self.bits {
            ...
            1 => Some(URATSELECT_A::ICM_CFG_MODIFIED),
            2 => Some(URATSELECT_A::ICM_DSCR_MODIFIED),
            3 => Some(URATSELECT_A::ICM_HASH_MODIFIED),
