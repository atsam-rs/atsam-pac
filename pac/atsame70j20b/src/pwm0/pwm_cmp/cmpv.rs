#[doc = "Reader of register CMPV"]
pub type R = crate::R<u32, super::CMPV>;
#[doc = "Writer for register CMPV"]
pub type W = crate::W<u32, super::CMPV>;
#[doc = "Register CMPV `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPV {
    type Type = u32;
    #[inline(always)]
