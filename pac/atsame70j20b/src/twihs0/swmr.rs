#[doc = "Reader of register SWMR"]
pub type R = crate::R<u32, super::SWMR>;
#[doc = "Writer for register SWMR"]
pub type W = crate::W<u32, super::SWMR>;
#[doc = "Register SWMR `reset()`'s with value 0"]
impl crate::ResetValue for super::SWMR {
    type Type = u32;
    #[inline(always)]
