#[doc = "Writer for register UPCON1SET"]
pub type W = crate::W<u32, super::UPCON1SET>;
#[doc = "Register UPCON1SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON1SET {
    type Type = u32;
    #[inline(always)]
