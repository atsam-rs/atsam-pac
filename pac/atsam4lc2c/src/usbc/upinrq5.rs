#[doc = "Reader of register UPINRQ5"]
pub type R = crate::R<u32, super::UPINRQ5>;
#[doc = "Writer for register UPINRQ5"]
pub type W = crate::W<u32, super::UPINRQ5>;
#[doc = "Register UPINRQ5 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ5 {
    type Type = u32;
    #[inline(always)]
