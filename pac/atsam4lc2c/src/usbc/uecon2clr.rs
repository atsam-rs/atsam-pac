#[doc = "Writer for register UECON2CLR"]
pub type W = crate::W<u32, super::UECON2CLR>;
#[doc = "Register UECON2CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON2CLR {
    type Type = u32;
    #[inline(always)]
