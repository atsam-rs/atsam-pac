...
pub type RXINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `TXOUTIS` writer - TXOUTI Set"]
pub type TXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `TXSTPIS` writer - TXSTPI Set"]
pub type TXSTPIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `PERRIS` writer - PERRI Set"]
pub type PERRIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `NAKEDIS` writer - NAKEDI Set"]
pub type NAKEDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `ERRORFIS` writer - ERRORFI Set"]
pub type ERRORFIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `RXSTALLDIS` writer - RXSTALLDI Set"]
pub type RXSTALLDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
#[doc = "Field `RAMACERIS` writer - RAMACERI Set"]
pub type RAMACERIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPSTA5SET_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - RXINI Set"]
    #[inline(always)]
    #[must_use]
