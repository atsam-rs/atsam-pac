...
impl From<crate::W<UESTA0SET_SPEC>> for W {
    #[inline(always)]
...
pub type TXINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `RXOUTIS` writer - RXOUTI Set"]
pub type RXOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `RXSTPIS` writer - RXSTPI Set"]
pub type RXSTPIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `NAKOUTIS` writer - NAKOUTI Set"]
pub type NAKOUTIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `NAKINIS` writer - NAKINI Set"]
pub type NAKINIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `STALLEDIS` writer - STALLEDI Set"]
pub type STALLEDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `RAMACERIS` writer - RAMACERI Set"]
pub type RAMACERIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
#[doc = "Field `NBUSYBKS` writer - NBUSYBK Set"]
pub type NBUSYBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UESTA0SET_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - TXINI Set"]
    #[inline(always)]
    #[must_use]
