#[doc = "Reader of register STERS%s"]
pub type R = crate::R<u32, super::STERS>;
#[doc = "Writer for register STERS%s"]
pub type W = crate::W<u32, super::STERS>;
#[doc = "Register STERS%s `reset()`'s with value 0"]
impl crate::ResetValue for super::STERS {
    type Type = u32;
    #[inline(always)]
