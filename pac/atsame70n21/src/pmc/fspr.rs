#[doc = "Reader of register FSPR"]
pub type R = crate::R<u32, super::FSPR>;
#[doc = "Writer for register FSPR"]
pub type W = crate::W<u32, super::FSPR>;
#[doc = "Register FSPR `reset()`'s with value 0"]
impl crate::ResetValue for super::FSPR {
    type Type = u32;
    #[inline(always)]
