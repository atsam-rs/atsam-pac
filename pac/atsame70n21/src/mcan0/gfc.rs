...
pub type RRFE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GFC_SPEC, RRFESELECT_A, O>;
...
pub type RRFS_W<'a, const O: u8> = crate::BitWriter<'a, u32, GFC_SPEC, RRFSSELECT_A, O>;
...
pub enum ANFESELECT_A {
    #[doc = "0: Message stored in Receive FIFO 0"]
    RX_FIFO_0 = 0,
    #[doc = "1: Message stored in Receive FIFO 1"]
    RX_FIFO_1 = 1,
}
...
impl<'a, const O: u8> ANFE_W<'a, O> {
    #[doc = "Message stored in Receive FIFO 0"]
    #[inline(always)]
    pub fn rx_fifo_0(self) -> &'a mut W {
        self.variant(ANFESELECT_A::RX_FIFO_0)
    }
    #[doc = "Message stored in Receive FIFO 1"]
    #[inline(always)]
