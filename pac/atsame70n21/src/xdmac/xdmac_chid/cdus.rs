#[doc = "Reader of register CDUS"]
pub type R = crate::R<u32, super::CDUS>;
#[doc = "Writer for register CDUS"]
pub type W = crate::W<u32, super::CDUS>;
#[doc = "Register CDUS `reset()`'s with value 0"]
impl crate::ResetValue for super::CDUS {
    type Type = u32;
    #[inline(always)]
