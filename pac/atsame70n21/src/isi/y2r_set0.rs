#[doc = "Reader of register Y2R_SET0"]
pub type R = crate::R<u32, super::Y2R_SET0>;
#[doc = "Writer for register Y2R_SET0"]
pub type W = crate::W<u32, super::Y2R_SET0>;
#[doc = "Register Y2R_SET0 `reset()`'s with value 0"]
impl crate::ResetValue for super::Y2R_SET0 {
    type Type = u32;
    #[inline(always)]
