...
pub type TID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIDM2_SPEC, u16, u16, 16, O>;
#[doc = "Field `ENID2` reader - Enable Copying of TID Matched Frames"]
pub type ENID2_R = crate::BitReader<bool>;
#[doc = "Field `ENID2` writer - Enable Copying of TID Matched Frames"]
pub type ENID2_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIDM2_SPEC, bool, O>;
impl R {
