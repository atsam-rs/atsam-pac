#[doc = "Register `EMR0` reader"]
pub struct R(crate::R<EMR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EMR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EMR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EMR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EMR0` writer"]
pub struct W(crate::W<EMR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EMR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EMR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EMR0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TRIGSRCA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMR0_SPEC, u8, TRIGSRCA_A, 2, O>;
...
pub type TRIGSRCB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EMR0_SPEC, u8, TRIGSRCB_A, 2, O>;
...
pub type NODIVCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, EMR0_SPEC, bool, O>;
impl R {
...
#[doc = "Extended Mode Register (channel = 0)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [emr0](index.html) module"]
pub struct EMR0_SPEC;
impl crate::RegisterSpec for EMR0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [emr0::R](R) reader structure"]
impl crate::Readable for EMR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [emr0::W](W) writer structure"]
impl crate::Writable for EMR0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EMR0 to value 0"]
impl crate::Resettable for EMR0_SPEC {
