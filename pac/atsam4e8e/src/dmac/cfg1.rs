...
pub type SRC_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG1_SPEC, u8, u8, 4, O>;
...
pub type DST_PER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG1_SPEC, u8, u8, 4, O>;
...
pub type SRC_H2SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, SRC_H2SEL_A, O>;
...
pub type DST_H2SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, DST_H2SEL_A, O>;
...
pub type SOD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, SOD_A, O>;
...
pub type LOCK_IF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, LOCK_IF_A, O>;
...
pub type LOCK_B_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, LOCK_B_A, O>;
...
pub type LOCK_IF_L_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG1_SPEC, LOCK_IF_L_A, O>;
...
pub type AHB_PROT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG1_SPEC, u8, u8, 3, O>;
...
pub type FIFOCFG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFG1_SPEC, u8, FIFOCFG_A, 2, O>;
