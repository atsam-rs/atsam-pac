...
pub type MIDV_B_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MID2_SPEC, u32, u32, 18, O>;
...
pub type MIDV_A_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MID2_SPEC, u16, u16, 11, O>;
#[doc = "Field `MIDE` reader - Identifier Version"]
pub type MIDE_R = crate::BitReader<bool>;
#[doc = "Field `MIDE` writer - Identifier Version"]
pub type MIDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MID2_SPEC, bool, O>;
impl R {
