...
pub struct R(crate::R<MDH0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDH0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDH0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDH0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MDH0` writer"]
pub struct W(crate::W<MDH0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDH0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDH0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDH0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MDH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDH0_SPEC, u32, u32, 32, O>;
impl R {
