#[doc = "Reader of register PRBS4"]
pub type R = crate::R<u32, super::PRBS4>;
#[doc = "Writer for register PRBS4"]
pub type W = crate::W<u32, super::PRBS4>;
#[doc = "Register PRBS4 `reset()`'s with value 0x3333_3333"]
impl crate::ResetValue for super::PRBS4 {
    type Type = u32;
    #[inline(always)]
