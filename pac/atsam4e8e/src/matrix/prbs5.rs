#[doc = "Reader of register PRBS5"]
pub type R = crate::R<u32, super::PRBS5>;
#[doc = "Writer for register PRBS5"]
pub type W = crate::W<u32, super::PRBS5>;
#[doc = "Register PRBS5 `reset()`'s with value 0x3333_3333"]
impl crate::ResetValue for super::PRBS5 {
    type Type = u32;
    #[inline(always)]
