...
pub type MDLC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MCR4_SPEC, u8, u8, 4, O>;
#[doc = "Field `MRTR` writer - Mailbox Remote Transmission Request"]
pub type MRTR_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCR4_SPEC, bool, O>;
#[doc = "Field `MACR` writer - Abort Request for Mailbox x"]
pub type MACR_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCR4_SPEC, bool, O>;
#[doc = "Field `MTCR` writer - Mailbox Transfer Command"]
pub type MTCR_W<'a, const O: u8> = crate::BitWriter<'a, u32, MCR4_SPEC, bool, O>;
impl W {
