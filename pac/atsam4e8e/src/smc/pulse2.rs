...
pub struct R(crate::R<PULSE2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PULSE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PULSE2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PULSE2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PULSE2` writer"]
pub struct W(crate::W<PULSE2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PULSE2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PULSE2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PULSE2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE2_SPEC, u8, u8, 7, O>;
...
pub type NCS_WR_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE2_SPEC, u8, u8, 7, O>;
...
pub type NRD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE2_SPEC, u8, u8, 7, O>;
...
pub type NCS_RD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE2_SPEC, u8, u8, 7, O>;
impl R {
