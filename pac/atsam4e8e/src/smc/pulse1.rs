...
pub struct R(crate::R<PULSE1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PULSE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PULSE1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PULSE1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PULSE1` writer"]
pub struct W(crate::W<PULSE1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PULSE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PULSE1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PULSE1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NWE_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE1_SPEC, u8, u8, 7, O>;
...
pub type NCS_WR_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE1_SPEC, u8, u8, 7, O>;
...
pub type NRD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE1_SPEC, u8, u8, 7, O>;
...
pub type NCS_RD_PULSE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PULSE1_SPEC, u8, u8, 7, O>;
impl R {
