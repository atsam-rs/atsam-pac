#[doc = "Writer for register UPCON7SET"]
pub type W = crate::W<u32, super::UPCON7SET>;
#[doc = "Register UPCON7SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON7SET {
    type Type = u32;
    #[inline(always)]
