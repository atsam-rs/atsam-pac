#[doc = "Writer for register UPCON4CLR"]
pub type W = crate::W<u32, super::UPCON4CLR>;
#[doc = "Register UPCON4CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON4CLR {
    type Type = u32;
    #[inline(always)]
