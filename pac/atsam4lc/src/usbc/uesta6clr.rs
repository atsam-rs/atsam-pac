#[doc = "Writer for register UESTA6CLR"]
pub type W = crate::W<u32, super::UESTA6CLR>;
#[doc = "Register UESTA6CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA6CLR {
    type Type = u32;
    #[inline(always)]
