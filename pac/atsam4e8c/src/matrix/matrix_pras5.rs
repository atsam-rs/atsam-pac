#[doc = "Register `MATRIX_PRAS5` reader"]
pub struct R(crate::R<MATRIX_PRAS5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATRIX_PRAS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MATRIX_PRAS5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MATRIX_PRAS5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATRIX_PRAS5` writer"]
pub struct W(crate::W<MATRIX_PRAS5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATRIX_PRAS5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MATRIX_PRAS5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MATRIX_PRAS5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Priority Register A for Slave 5\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [matrix_pras5](index.html) module"]
pub struct MATRIX_PRAS5_SPEC;
impl crate::RegisterSpec for MATRIX_PRAS5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matrix_pras5::R](R) reader structure"]
impl crate::Readable for MATRIX_PRAS5_SPEC {
    type Reader = R;
}
...
#[doc = "`reset()` method sets MATRIX_PRAS5 to value 0x3333_3333"]
