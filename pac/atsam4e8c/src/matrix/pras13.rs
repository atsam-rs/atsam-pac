#[doc = "Reader of register PRAS13"]
pub type R = crate::R<u32, super::PRAS13>;
#[doc = "Writer for register PRAS13"]
pub type W = crate::W<u32, super::PRAS13>;
#[doc = "Register PRAS13 `reset()`'s with value 0x3333_3333"]
impl crate::ResetValue for super::PRAS13 {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn m7pr(&self) -> M7PR_R {
        M7PR_R::new(((self.bits >> 28) & 0x03) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - Master 0 Priority"]
