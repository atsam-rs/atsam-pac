#[doc = "Reader of register TS"]
pub type R = crate::R<u32, super::TS>;
#[doc = "Writer for register TS"]
pub type W = crate::W<u32, super::TS>;
#[doc = "Register TS `reset()`'s with value 0"]
impl crate::ResetValue for super::TS {
    type Type = u32;
    #[inline(always)]
