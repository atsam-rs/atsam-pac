...
pub type MIDV_B_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAM7_SPEC, u32, u32, 18, O>;
...
pub type MIDV_A_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAM7_SPEC, u16, u16, 11, O>;
