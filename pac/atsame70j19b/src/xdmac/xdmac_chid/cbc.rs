#[doc = "Reader of register CBC"]
pub type R = crate::R<u32, super::CBC>;
#[doc = "Writer for register CBC"]
pub type W = crate::W<u32, super::CBC>;
#[doc = "Register CBC `reset()`'s with value 0"]
impl crate::ResetValue for super::CBC {
    type Type = u32;
    #[inline(always)]
