#[doc = "Writer for register US_IER_USART_MODE"]
pub type W = crate::W<u32, super::US_IER_USART_MODE>;
#[doc = "Register US_IER_USART_MODE `reset()`'s with value 0"]
impl crate::ResetValue for super::US_IER_USART_MODE {
    type Type = u32;
    #[inline(always)]
