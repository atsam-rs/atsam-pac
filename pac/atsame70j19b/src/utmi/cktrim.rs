#[doc = "Reader of register CKTRIM"]
pub type R = crate::R<u32, super::CKTRIM>;
#[doc = "Writer for register CKTRIM"]
pub type W = crate::W<u32, super::CKTRIM>;
#[doc = "Register CKTRIM `reset()`'s with value 0"]
impl crate::ResetValue for super::CKTRIM {
    type Type = u32;
    #[inline(always)]
