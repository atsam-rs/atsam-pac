#[doc = "Writer for register HSTPIPIDR_BLK_MODE[%s]"]
pub type W = crate::W<u32, super::HSTPIPIDR_BLK_MODE>;
#[doc = "Register HSTPIPIDR_BLK_MODE[%s]
`reset()`'s with value 0"]
impl crate::ResetValue for super::HSTPIPIDR_BLK_MODE {
    type Type = u32;
    #[inline(always)]
