...
pub type TID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIDM1_SPEC, u16, u16, 16, O>;
#[doc = "Field `ENID1` reader - Enable Copying of TID Matched Frames"]
pub type ENID1_R = crate::BitReader<bool>;
#[doc = "Field `ENID1` writer - Enable Copying of TID Matched Frames"]
pub type ENID1_W<'a, const O: u8> = crate::BitWriter<'a, u32, TIDM1_SPEC, bool, O>;
impl R {
