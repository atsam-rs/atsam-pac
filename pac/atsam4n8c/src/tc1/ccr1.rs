...
pub type CLKEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR1_SPEC, bool, O>;
#[doc = "Field `CLKDIS` writer - Counter Clock Disable Command"]
pub type CLKDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR1_SPEC, bool, O>;
#[doc = "Field `SWTRG` writer - Software Trigger Command"]
pub type SWTRG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CCR1_SPEC, bool, O>;
impl W {
