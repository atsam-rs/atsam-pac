# Microchip/Atmel ATSAM4S4A PAC for Rust

This repository holds the Peripheral Access Crate for the Atmel `ATSAM4S4A` microcontroller.

[![Docs](https://docs.rs/atsam4s4a-pac/badge.svg)](https://docs.rs/atsam4s4a-pac/latest/)
