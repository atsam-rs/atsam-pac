...
pub struct W(crate::W<CMPMUPD2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMPMUPD2_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CMPMUPD2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMPMUPD2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CENUPD` writer - Comparison x Enable Update"]
pub type CENUPD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMPMUPD2_SPEC, bool, O>;
#[doc = "Field `CTRUPD` writer - Comparison x Trigger Update"]
pub type CTRUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPMUPD2_SPEC, u8, u8, 4, O>;
#[doc = "Field `CPRUPD` writer - Comparison x Period Update"]
pub type CPRUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPMUPD2_SPEC, u8, u8, 4, O>;
#[doc = "Field `CUPRUPD` writer - Comparison x Update Period Update"]
pub type CUPRUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMPMUPD2_SPEC, u8, u8, 4, O>;
impl W {
...
#[doc = "PWM Comparison 2 Mode Update Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cmpmupd2](index.html) module"]
pub struct CMPMUPD2_SPEC;
impl crate::RegisterSpec for CMPMUPD2_SPEC {
    type Ux = u32;
}
