...
pub type FCMD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EEFC_FCR_SPEC, u8, FCMDSELECT_AW, 8, O>;
...
pub type FKEY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EEFC_FCR_SPEC, u8, FKEYSELECT_AW, 8, O>;
