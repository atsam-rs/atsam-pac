#[doc = "Register `US_CSR` reader"]
pub struct R(crate::R<US_CSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<US_CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<US_CSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<US_CSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `TIMEOUT` reader - Receiver Time-out (cleared by writing a one to bit US_CR.STTTO)"]
...
pub struct US_CSR_SPEC;
impl crate::RegisterSpec for US_CSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [us_csr::R](R) reader structure"]
impl crate::Readable for US_CSR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets US_CSR to value 0"]
impl crate::Resettable for US_CSR_SPEC {
