#[doc = "Reader of register DMA_P_ADDR"]
pub type R = crate::R<u32, super::DMA_P_ADDR>;
#[doc = "Writer for register DMA_P_ADDR"]
pub type W = crate::W<u32, super::DMA_P_ADDR>;
#[doc = "Register DMA_P_ADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_P_ADDR {
    type Type = u32;
    #[inline(always)]
