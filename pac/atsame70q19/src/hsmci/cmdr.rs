...
pub type RSPTYP_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMDR_SPEC, u8, RSPTYPSELECT_AW, 2, O>;
...
pub type SPCMD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CMDR_SPEC, u8, SPCMDSELECT_AW, 3, O>;
...
pub type OPDCMD_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMDR_SPEC, OPDCMDSELECT_AW, O>;
...
pub type MAXLAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMDR_SPEC, MAXLATSELECT_AW, O>;
...
pub type TRCMD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CMDR_SPEC, u8, TRCMDSELECT_AW, 2, O>;
...
pub type TRDIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMDR_SPEC, TRDIRSELECT_AW, O>;
...
pub type TRTYP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CMDR_SPEC, u8, TRTYPSELECT_AW, 3, O>;
...
pub type IOSPCMD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CMDR_SPEC, u8, IOSPCMDSELECT_AW, 2, O>;
...
pub type ATACS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMDR_SPEC, ATACSSELECT_AW, O>;
