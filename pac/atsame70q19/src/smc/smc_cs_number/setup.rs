...
pub type NWE_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP_SPEC, u8, u8, 6, O>;
...
pub type NCS_WR_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP_SPEC, u8, u8, 6, O>;
...
pub type NRD_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP_SPEC, u8, u8, 6, O>;
...
pub type NCS_RD_SETUP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SETUP_SPEC, u8, u8, 6, O>;
impl R {
