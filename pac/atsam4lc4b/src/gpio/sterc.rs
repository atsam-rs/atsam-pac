#[doc = "Reader of register STERC%s"]
pub type R = crate::R<u32, super::STERC>;
#[doc = "Writer for register STERC%s"]
pub type W = crate::W<u32, super::STERC>;
#[doc = "Register STERC%s `reset()`'s with value 0"]
impl crate::ResetValue for super::STERC {
    type Type = u32;
    #[inline(always)]
