#[doc = "Reader of register EVER%s"]
pub type R = crate::R<u32, super::EVER>;
#[doc = "Writer for register EVER%s"]
pub type W = crate::W<u32, super::EVER>;
#[doc = "Register EVER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::EVER {
    type Type = u32;
    #[inline(always)]
