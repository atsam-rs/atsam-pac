#[doc = "Reader of register PDER%s"]
pub type R = crate::R<u32, super::PDER>;
#[doc = "Writer for register PDER%s"]
pub type W = crate::W<u32, super::PDER>;
#[doc = "Register PDER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::PDER {
    type Type = u32;
    #[inline(always)]
