...
pub type RA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RA_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Register A"]
    #[inline(always)]
    pub fn ra(&self) -> RA_R {
...
#[doc = "`reset()` method sets RA%s to value 0"]
