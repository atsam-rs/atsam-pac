#[doc = "Register `UPCFG7` reader"]
pub struct R(crate::R<UPCFG7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPCFG7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UPCFG7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UPCFG7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UPCFG7` writer"]
pub struct W(crate::W<UPCFG7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UPCFG7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UPCFG7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UPCFG7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PBK_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCFG7_SPEC, PBKSELECT_A, O>;
...
pub type PSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UPCFG7_SPEC, u8, PSIZESELECT_A, 3, O>;
...
pub type PTOKEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UPCFG7_SPEC, u8, PTOKENSELECT_A, 2, O>;
...
pub type PTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UPCFG7_SPEC, u8, PTYPESELECT_A, 2, O>;
...
pub type PINGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCFG7_SPEC, bool, O>;
...
pub type BINTERVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UPCFG7_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Pipe Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upcfg7](index.html) module"]
pub struct UPCFG7_SPEC;
impl crate::RegisterSpec for UPCFG7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upcfg7::R](R) reader structure"]
impl crate::Readable for UPCFG7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [upcfg7::W](W) writer structure"]
impl crate::Writable for UPCFG7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UPCFG7 to value 0"]
impl crate::Resettable for UPCFG7_SPEC {
