#[doc = "Reader of register UPINRQ6"]
pub type R = crate::R<u32, super::UPINRQ6>;
#[doc = "Writer for register UPINRQ6"]
pub type W = crate::W<u32, super::UPINRQ6>;
#[doc = "Register UPINRQ6 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ6 {
    type Type = u32;
    #[inline(always)]
