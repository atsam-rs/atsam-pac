#[doc = "Reader of register EMR0"]
pub type R = crate::R<u32, super::EMR0>;
#[doc = "Writer for register EMR0"]
pub type W = crate::W<u32, super::EMR0>;
#[doc = "Register EMR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::EMR0 {
    type Type = u32;
    #[inline(always)]
