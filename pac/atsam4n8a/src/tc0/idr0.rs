...
pub struct W(crate::W<IDR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IDR0_SPEC>;
    #[inline(always)]
...
impl From<crate::W<IDR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IDR0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Interrupt Disable Register (channel = 0)\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [idr0](index.html) module"]
pub struct IDR0_SPEC;
impl crate::RegisterSpec for IDR0_SPEC {
    type Ux = u32;
}
