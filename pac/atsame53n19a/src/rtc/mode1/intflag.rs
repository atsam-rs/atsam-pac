...
#[doc = "Field `CMP2` reader - Compare 2"]
...
#[doc = "Field `CMP2` writer - Compare 2"]
pub struct CMP2_W<'a> {
    w: &'a mut W,
}
impl<'a> CMP2_W<'a> {
...
#[doc = "Field `CMP3` reader - Compare 3"]
...
#[doc = "Field `CMP3` writer - Compare 3"]
pub struct CMP3_W<'a> {
    w: &'a mut W,
}
impl<'a> CMP3_W<'a> {
...
impl R {
    ...
    pub fn cmp1(&self) -> CMP1_R {
        CMP1_R::new(((self.bits >> 9) & 0x01) != 0)
    }
    #[doc = "Bit 10 - Compare 2"]
    #[inline(always)]
    pub fn cmp2(&self) -> CMP2_R {
        CMP2_R::new(((self.bits >> 10) & 0x01) != 0)
    }
    #[doc = "Bit 11 - Compare 3"]
    #[inline(always)]
    pub fn cmp3(&self) -> CMP3_R {
        CMP3_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    #[doc = "Bit 14 - Tamper"]
    #[inline(always)]
