#[doc = "Register `EISIER` reader"]
pub struct R(crate::R<EISIER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EISIER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EISIER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EISIER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EISIER` writer"]
pub struct W(crate::W<EISIER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EISIER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EISIER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EISIER_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Error Interrupt Signal Enable\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eisier](index.html) module"]
pub struct EISIER_SPEC;
impl crate::RegisterSpec for EISIER_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [eisier::R](R) reader structure"]
impl crate::Readable for EISIER_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eisier::W](W) writer structure"]
impl crate::Writable for EISIER_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EISIER to value 0"]
impl crate::Resettable for EISIER_SPEC {
    #[inline(always)]
