#[doc = "Register `UPCFG2` reader"]
pub struct R(crate::R<UPCFG2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPCFG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UPCFG2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UPCFG2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UPCFG2` writer"]
pub struct W(crate::W<UPCFG2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UPCFG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UPCFG2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UPCFG2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PBK_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCFG2_SPEC, PBKSELECT_A, O>;
...
pub type PSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UPCFG2_SPEC, u8, PSIZESELECT_A, 3, O>;
...
pub type PTOKEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UPCFG2_SPEC, u8, PTOKENSELECT_A, 2, O>;
...
pub type PTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UPCFG2_SPEC, u8, PTYPESELECT_A, 2, O>;
...
pub type PINGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCFG2_SPEC, bool, O>;
...
pub type BINTERVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UPCFG2_SPEC, u8, u8, 8, O>;
impl R {
...
pub struct UPCFG2_SPEC;
impl crate::RegisterSpec for UPCFG2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upcfg2::R](R) reader structure"]
impl crate::Readable for UPCFG2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [upcfg2::W](W) writer structure"]
impl crate::Writable for UPCFG2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UPCFG2 to value 0"]
impl crate::Resettable for UPCFG2_SPEC {
