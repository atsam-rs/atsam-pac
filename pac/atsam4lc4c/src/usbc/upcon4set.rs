#[doc = "Writer for register UPCON4SET"]
pub type W = crate::W<u32, super::UPCON4SET>;
#[doc = "Register UPCON4SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON4SET {
    type Type = u32;
    #[inline(always)]
