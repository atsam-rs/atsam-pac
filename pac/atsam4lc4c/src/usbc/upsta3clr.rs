#[doc = "Writer for register UPSTA3CLR"]
pub type W = crate::W<u32, super::UPSTA3CLR>;
#[doc = "Register UPSTA3CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA3CLR {
    type Type = u32;
    #[inline(always)]
