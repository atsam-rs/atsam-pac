#[doc = "Writer for register UECON6SET"]
pub type W = crate::W<u32, super::UECON6SET>;
#[doc = "Register UECON6SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON6SET {
    type Type = u32;
    #[inline(always)]
