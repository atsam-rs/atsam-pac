...
pub struct R(crate::R<MDL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MDL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MDL1` writer"]
pub struct W(crate::W<MDL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MDL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MDL1_SPEC, u32, u32, 32, O>;
impl R {
