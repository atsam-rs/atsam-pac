#[doc = "Register `MSR7` reader"]
pub struct R(crate::R<MSR7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MSR7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MSR7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MSR7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Mailbox Status Register (MB = 7)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [msr7](index.html) module"]
pub struct MSR7_SPEC;
impl crate::RegisterSpec for MSR7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [msr7::R](R) reader structure"]
impl crate::Readable for MSR7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MSR7 to value 0"]
impl crate::Resettable for MSR7_SPEC {
