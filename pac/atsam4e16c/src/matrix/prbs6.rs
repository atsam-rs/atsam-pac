#[doc = "Reader of register PRBS6"]
pub type R = crate::R<u32, super::PRBS6>;
#[doc = "Writer for register PRBS6"]
pub type W = crate::W<u32, super::PRBS6>;
#[doc = "Register PRBS6 `reset()`'s with value 0x3333_3333"]
impl crate::ResetValue for super::PRBS6 {
    type Type = u32;
    #[inline(always)]
