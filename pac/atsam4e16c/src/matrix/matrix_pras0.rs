...
pub struct R(crate::R<MATRIX_PRAS0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATRIX_PRAS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MATRIX_PRAS0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MATRIX_PRAS0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATRIX_PRAS0` writer"]
pub struct W(crate::W<MATRIX_PRAS0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATRIX_PRAS0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MATRIX_PRAS0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MATRIX_PRAS0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct MATRIX_PRAS0_SPEC;
impl crate::RegisterSpec for MATRIX_PRAS0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matrix_pras0::R](R) reader structure"]
impl crate::Readable for MATRIX_PRAS0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [matrix_pras0::W](W) writer structure"]
impl crate::Writable for MATRIX_PRAS0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MATRIX_PRAS0 to value 0x3333_3333"]
impl crate::Resettable for MATRIX_PRAS0_SPEC {
