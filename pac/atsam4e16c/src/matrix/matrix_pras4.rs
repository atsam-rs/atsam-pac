#[doc = "Register `MATRIX_PRAS4` reader"]
pub struct R(crate::R<MATRIX_PRAS4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MATRIX_PRAS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MATRIX_PRAS4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MATRIX_PRAS4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MATRIX_PRAS4` writer"]
pub struct W(crate::W<MATRIX_PRAS4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MATRIX_PRAS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MATRIX_PRAS4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MATRIX_PRAS4_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Priority Register A for Slave 4\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [matrix_pras4](index.html) module"]
pub struct MATRIX_PRAS4_SPEC;
impl crate::RegisterSpec for MATRIX_PRAS4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [matrix_pras4::R](R) reader structure"]
impl crate::Readable for MATRIX_PRAS4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [matrix_pras4::W](W) writer structure"]
impl crate::Writable for MATRIX_PRAS4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MATRIX_PRAS4 to value 0x3333_3333"]
impl crate::Resettable for MATRIX_PRAS4_SPEC {
    const RESET_VALUE: Self::Ux = 0x3333_3333;
}
