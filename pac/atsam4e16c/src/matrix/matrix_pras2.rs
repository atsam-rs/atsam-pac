...
pub type M5PR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MATRIX_PRAS2_SPEC, u8, u8, 2, O>;
#[doc = "Field `M6PR` reader - Master 6 Priority"]
pub type M6PR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `M6PR` writer - Master 6 Priority"]
pub type M6PR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MATRIX_PRAS2_SPEC, u8, u8, 2, O>;
impl R {
...
#[doc = "`reset()` method sets MATRIX_PRAS2 to value 0x3333_3333"]
