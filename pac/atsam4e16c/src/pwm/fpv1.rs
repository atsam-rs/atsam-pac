#[doc = "Reader of register FPV1"]
pub type R = crate::R<u32, super::FPV1>;
#[doc = "Writer for register FPV1"]
pub type W = crate::W<u32, super::FPV1>;
#[doc = "Register FPV1 `reset()`'s with value 0"]
impl crate::ResetValue for super::FPV1 {
    type Type = u32;
    #[inline(always)]
