#[doc = "Writer for register UPCON0CLR"]
pub type W = crate::W<u32, super::UPCON0CLR>;
#[doc = "Register UPCON0CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON0CLR {
    type Type = u32;
    #[inline(always)]
