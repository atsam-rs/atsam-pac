#[doc = "Writer for register UESTA6SET"]
pub type W = crate::W<u32, super::UESTA6SET>;
#[doc = "Register UESTA6SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA6SET {
    type Type = u32;
    #[inline(always)]
