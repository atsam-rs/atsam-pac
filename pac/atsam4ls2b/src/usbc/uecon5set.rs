#[doc = "Writer for register UECON5SET"]
pub type W = crate::W<u32, super::UECON5SET>;
#[doc = "Register UECON5SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON5SET {
    type Type = u32;
    #[inline(always)]
