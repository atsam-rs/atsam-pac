#[doc = "Writer for register UESTA1SET"]
pub type W = crate::W<u32, super::UESTA1SET>;
#[doc = "Register UESTA1SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA1SET {
    type Type = u32;
    #[inline(always)]
