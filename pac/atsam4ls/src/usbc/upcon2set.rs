#[doc = "Writer for register UPCON2SET"]
pub type W = crate::W<u32, super::UPCON2SET>;
#[doc = "Register UPCON2SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON2SET {
    type Type = u32;
    #[inline(always)]
