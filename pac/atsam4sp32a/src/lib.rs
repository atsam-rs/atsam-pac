#![doc = "Peripheral access API for ATSAM4SP32A microcontrollers (generated using svd2rust v0.19.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
#[doc = "Synchronous Serial Controller"]
pub mod ssc;
#[doc = "PRIME Power Line Communication (PPLC) Transceiver"]
pub struct PPLC {
    _marker: PhantomData<*const ()>,
}
unsafe impl Send for PPLC {}
impl PPLC {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const pplc::RegisterBlock = 0x4000_8000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const pplc::RegisterBlock {
        Self::PTR
    }
}
impl Deref for PPLC {
    type Target = pplc::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for PPLC {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PPLC").finish()
    }
}
#[doc = "PRIME Power Line Communication (PPLC) Transceiver"]
pub mod pplc;
