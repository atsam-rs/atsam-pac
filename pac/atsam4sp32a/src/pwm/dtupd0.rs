...
pub type DTHUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DTUPD0_SPEC, u16, u16, 16, O>;
#[doc = "Field `DTLUPD` writer - Dead-Time Value Update for PWMLx Output"]
pub type DTLUPD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DTUPD0_SPEC, u16, u16, 16, O>;
impl W {
