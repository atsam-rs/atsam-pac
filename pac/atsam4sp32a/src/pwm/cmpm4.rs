...
impl core::ops::Deref for R {
    type Target = crate::R<CMPM4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMPM4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMPM4_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::ops::Deref for W {
    type Target = crate::W<CMPM4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMPM4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMPM4_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`reset()` method sets CMPM4 to value 0"]
impl crate::Resettable for CMPM4_SPEC {
    #[inline(always)]
