...
#[doc = "Field `PPLCENS` reader - PPLC Enable Status"]
pub struct PPLCENS_R(crate::FieldReader<bool, bool>);
impl PPLCENS_R {
    pub(crate) fn new(bits: bool) -> Self {
        PPLCENS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PPLCENS_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[doc = "Bit 16 - PPLC Enable Status"]
    #[inline(always)]
    pub fn pplcens(&self) -> PPLCENS_R {
        PPLCENS_R::new(((self.bits >> 16) & 0x01) != 0)
    }
}
