...
impl ARCH_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, ARCH_A> {
        ...
        match self.bits {
            ...
            136 => Val(ARCH_A::SAM3SXA),
            137 => Val(ARCH_A::SAM3SXB),
            138 => Val(ARCH_A::SAM3SXC),
            146 => Val(ARCH_A::AT91X92),
            147 => Val(ARCH_A::SAM3NXA),
            148 => Val(ARCH_A::SAM3NXB),
            149 => Val(ARCH_A::SAM3NXC),
    ...
    #[doc = "Checks if the value of the field is `SAM4MXXC`"]
    #[inline(always)]
    pub fn is_sam4mxx_c(&self) -> bool {
        *self == ARCH_A::SAM4MXXC
    }
