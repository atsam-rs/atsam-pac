...
#[doc = "PLLA Register"]
pub mod ckgr_pllar;
#[doc = "PLLB Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ckgr_pllbr](ckgr_pllbr) module"]
pub type CKGR_PLLBR = crate::Reg<u32, _CKGR_PLLBR>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _CKGR_PLLBR;
#[doc = "`read()` method returns [ckgr_pllbr::R](ckgr_pllbr::R) reader structure"]
impl crate::Readable for CKGR_PLLBR {}
#[doc = "`write(|w| ..)` method takes [ckgr_pllbr::W](ckgr_pllbr::W) writer structure"]
impl crate::Writable for CKGR_PLLBR {}
#[doc = "PLLB Register"]
pub mod ckgr_pllbr;
