# Microchip/Atmel ATSAM4SD32B PAC for Rust

This repository holds the Peripheral Access Crate for the Atmel `ATSAM4SD32B` microcontroller.

[![Docs](https://docs.rs/atsam4sd32b-pac/badge.svg)](https://docs.rs/atsam4sd32b-pac/latest/)
