#[doc = "Reader of register NCMDR"]
pub type R = crate::R<u32, super::NCMDR>;
#[doc = "Writer for register NCMDR"]
pub type W = crate::W<u32, super::NCMDR>;
#[doc = "Register NCMDR `reset()`'s with value 0"]
impl crate::ResetValue for super::NCMDR {
    type Type = u32;
    #[inline(always)]
