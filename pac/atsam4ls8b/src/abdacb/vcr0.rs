#[doc = "Reader of register VCR0"]
pub type R = crate::R<u32, super::VCR0>;
#[doc = "Writer for register VCR0"]
pub type W = crate::W<u32, super::VCR0>;
#[doc = "Register VCR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::VCR0 {
    type Type = u32;
    #[inline(always)]
