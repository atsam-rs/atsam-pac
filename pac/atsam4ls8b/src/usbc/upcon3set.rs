...
pub type RXINES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `TXOUTES` writer - TXOUTE Set"]
pub type TXOUTES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `TXSTPES` writer - TXSTPE Set"]
pub type TXSTPES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `PERRES` writer - PERRE Set"]
pub type PERRES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `NAKEDES` writer - NAKEDE Set"]
pub type NAKEDES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `ERRORFIES` writer - ERRORFIE Set"]
pub type ERRORFIES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `RXSTALLDES` writer - RXSTALLDE Set"]
pub type RXSTALLDES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `RAMACERES` writer - RAMACERE Set"]
pub type RAMACERES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `NBUSYBKES` writer - NBUSYBKE Set"]
pub type NBUSYBKES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `FIFOCONS` writer - FIFOCON Set"]
pub type FIFOCONS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `PFREEZES` writer - PFREEZE Set"]
pub type PFREEZES_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `INITDTGLS` writer - INITDTGL Set"]
pub type INITDTGLS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
#[doc = "Field `INITBKS` writer - INITBK Set"]
pub type INITBKS_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCON3SET_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - RXINE Set"]
    #[inline(always)]
    #[must_use]
