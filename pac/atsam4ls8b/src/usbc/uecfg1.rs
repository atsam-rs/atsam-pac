...
impl From<crate::R<UECFG1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<UECFG1_SPEC>> for W {
    #[inline(always)]
...
pub type EPBK_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECFG1_SPEC, EPBKSELECT_A, O>;
...
pub type EPSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UECFG1_SPEC, u8, EPSIZESELECT_A, 3, O>;
...
pub type EPDIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, UECFG1_SPEC, EPDIRSELECT_A, O>;
...
pub type EPTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UECFG1_SPEC, u8, EPTYPESELECT_A, 2, O>;
...
pub type REPNB_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UECFG1_SPEC, u8, u8, 4, O>;
impl R {
