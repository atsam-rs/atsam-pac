#[doc = "Writer for register UECON0SET"]
pub type W = crate::W<u32, super::UECON0SET>;
#[doc = "Register UECON0SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON0SET {
    type Type = u32;
    #[inline(always)]
