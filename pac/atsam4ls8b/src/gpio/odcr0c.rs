#[doc = "Reader of register ODCR0C%s"]
pub type R = crate::R<u32, super::ODCR0C>;
#[doc = "Writer for register ODCR0C%s"]
pub type W = crate::W<u32, super::ODCR0C>;
#[doc = "Register ODCR0C%s `reset()`'s with value 0"]
impl crate::ResetValue for super::ODCR0C {
    type Type = u32;
    #[inline(always)]
