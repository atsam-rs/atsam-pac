#[doc = "Writer for register UESTA3SET"]
pub type W = crate::W<u32, super::UESTA3SET>;
#[doc = "Register UESTA3SET `reset()`'s with value 0"]
impl crate::ResetValue for super::UESTA3SET {
    type Type = u32;
    #[inline(always)]
