#[doc = "Writer for register UECON6CLR"]
pub type W = crate::W<u32, super::UECON6CLR>;
#[doc = "Register UECON6CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UECON6CLR {
    type Type = u32;
    #[inline(always)]
