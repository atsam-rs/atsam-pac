#[doc = "Writer for register UPSTA5CLR"]
pub type W = crate::W<u32, super::UPSTA5CLR>;
#[doc = "Register UPSTA5CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA5CLR {
    type Type = u32;
    #[inline(always)]
