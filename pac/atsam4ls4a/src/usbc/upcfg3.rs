#[doc = "Register `UPCFG3` reader"]
pub struct R(crate::R<UPCFG3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UPCFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UPCFG3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UPCFG3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UPCFG3` writer"]
pub struct W(crate::W<UPCFG3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UPCFG3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UPCFG3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UPCFG3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PBK_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCFG3_SPEC, PBKSELECT_A, O>;
...
pub type PSIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UPCFG3_SPEC, u8, PSIZESELECT_A, 3, O>;
...
pub type PTOKEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, UPCFG3_SPEC, u8, PTOKENSELECT_A, 2, O>;
...
pub type PTYPE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, UPCFG3_SPEC, u8, PTYPESELECT_A, 2, O>;
...
pub type PINGEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, UPCFG3_SPEC, bool, O>;
...
pub type BINTERVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, UPCFG3_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "Pipe Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [upcfg3](index.html) module"]
pub struct UPCFG3_SPEC;
impl crate::RegisterSpec for UPCFG3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [upcfg3::R](R) reader structure"]
impl crate::Readable for UPCFG3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [upcfg3::W](W) writer structure"]
impl crate::Writable for UPCFG3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UPCFG3 to value 0"]
impl crate::Resettable for UPCFG3_SPEC {
