#[doc = "Writer for register UPCON5CLR"]
pub type W = crate::W<u32, super::UPCON5CLR>;
#[doc = "Register UPCON5CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPCON5CLR {
    type Type = u32;
    #[inline(always)]
