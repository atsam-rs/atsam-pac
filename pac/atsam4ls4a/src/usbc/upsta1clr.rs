#[doc = "Writer for register UPSTA1CLR"]
pub type W = crate::W<u32, super::UPSTA1CLR>;
#[doc = "Register UPSTA1CLR `reset()`'s with value 0"]
impl crate::ResetValue for super::UPSTA1CLR {
    type Type = u32;
    #[inline(always)]
