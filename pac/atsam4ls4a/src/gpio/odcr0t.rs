#[doc = "Reader of register ODCR0T%s"]
pub type R = crate::R<u32, super::ODCR0T>;
#[doc = "Writer for register ODCR0T%s"]
pub type W = crate::W<u32, super::ODCR0T>;
#[doc = "Register ODCR0T%s `reset()`'s with value 0"]
impl crate::ResetValue for super::ODCR0T {
    type Type = u32;
    #[inline(always)]
