#[doc = "Reader of register USB"]
pub type R = crate::R<u32, super::USB>;
#[doc = "Writer for register USB"]
pub type W = crate::W<u32, super::USB>;
#[doc = "Register USB `reset()`'s with value 0"]
impl crate::ResetValue for super::USB {
    type Type = u32;
    #[inline(always)]
