#[doc = "Reader of register TIDM2"]
pub type R = crate::R<u32, super::TIDM2>;
#[doc = "Writer for register TIDM2"]
pub type W = crate::W<u32, super::TIDM2>;
#[doc = "Register TIDM2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TIDM2 {
    type Type = u32;
    #[inline(always)]
