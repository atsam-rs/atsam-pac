...
pub type RSTRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RSTTX` writer - Reset Transmitter"]
pub type RSTTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RXEN` writer - Receiver Enable"]
pub type RXEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RXDIS` writer - Receiver Disable"]
pub type RXDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `TXEN` writer - Transmitter Enable"]
pub type TXEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `TXDIS` writer - Transmitter Disable"]
pub type TXDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RSTSTA` writer - Reset Status Bits"]
pub type RSTSTA_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `STTBRK` writer - Start Break"]
pub type STTBRK_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `STPBRK` writer - Stop Break"]
pub type STPBRK_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `STTTO` writer - Clear TIMEOUT Flag and Start Time-out After Next Character Received"]
pub type STTTO_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `SENDA` writer - Send Address"]
pub type SENDA_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RSTIT` writer - Reset Iterations"]
pub type RSTIT_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RSTNACK` writer - Reset Non Acknowledge"]
pub type RSTNACK_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RETTO` writer - Start Time-out Immediately"]
pub type RETTO_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `DTREN` writer - Data Terminal Ready Enable"]
pub type DTREN_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `DTRDIS` writer - Data Terminal Ready Disable"]
pub type DTRDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RTSEN` writer - Request to Send Pin Control"]
pub type RTSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `RTSDIS` writer - Request to Send Pin Control"]
pub type RTSDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `LINABT` writer - Abort LIN Transmission"]
pub type LINABT_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
#[doc = "Field `LINWKUP` writer - Send LIN Wakeup Signal"]
pub type LINWKUP_W<'a, const O: u8> = crate::BitWriter<'a, u32, US_CR_SPEC, bool, O>;
impl W {
