...
pub struct W(crate::W<HSTPIPICR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HSTPIPICR_SPEC>;
    #[inline(always)]
...
impl From<crate::W<HSTPIPICR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HSTPIPICR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Host Pipe Clear Register (n = 0) 0\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hstpipicr](index.html) module"]
