...
pub type FSOS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TFMR_SPEC, u8, FSOSSELECT_A, 3, O>;
...
pub type FSEDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TFMR_SPEC, FSEDGESELECT_A, O>;
