#[doc = "Reader of register RPR0"]
pub type R = crate::R<u32, super::RPR0>;
#[doc = "Writer for register RPR0"]
pub type W = crate::W<u32, super::RPR0>;
#[doc = "Register RPR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::RPR0 {
    type Type = u32;
    #[inline(always)]
