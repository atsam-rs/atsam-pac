...
#[doc = "Field `VERSION` reader - Reserved. Value subject to change. No functionality associated. This is the Atmel internal version of the macrocell."]
pub type VERSION_R = crate::FieldReader<u16, u16>;
#[doc = "Field `VARIANT` reader - Reserved. Value subject to change. No functionality associated."]
...
#[doc = "`reset()` method sets VERSION to value 0x0402"]
impl crate::Resettable for VERSION_SPEC {
    const RESET_VALUE: Self::Ux = 0x0402;
}
