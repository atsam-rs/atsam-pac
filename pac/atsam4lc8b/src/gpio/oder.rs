#[doc = "Reader of register ODER%s"]
pub type R = crate::R<u32, super::ODER>;
#[doc = "Writer for register ODER%s"]
pub type W = crate::W<u32, super::ODER>;
#[doc = "Register ODER%s `reset()`'s with value 0"]
impl crate::ResetValue for super::ODER {
    type Type = u32;
    #[inline(always)]
