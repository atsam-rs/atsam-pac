#[doc = "Writer for register IER_USART"]
pub type W = crate::W<u32, super::IER_USART>;
#[doc = "Register IER_USART `reset()`'s with value 0"]
impl crate::ResetValue for super::IER_USART {
    type Type = u32;
    #[inline(always)]
