#[doc = "Reader of register UPINRQ2"]
pub type R = crate::R<u32, super::UPINRQ2>;
#[doc = "Writer for register UPINRQ2"]
pub type W = crate::W<u32, super::UPINRQ2>;
#[doc = "Register UPINRQ2 `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UPINRQ2 {
    type Type = u32;
    #[inline(always)]
