...
impl core::ops::Deref for R {
    type Target = crate::R<MDL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MDL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MDL3_SPEC>) -> Self {
        R(reader)
    }
}
...
impl From<crate::W<MDL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDL3_SPEC>) -> Self {
        W(writer)
    }
}
