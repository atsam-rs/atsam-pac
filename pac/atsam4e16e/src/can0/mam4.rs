#[doc = "Register `MAM4` reader"]
pub struct R(crate::R<MAM4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MAM4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MAM4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MAM4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAM4` writer"]
pub struct W(crate::W<MAM4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MAM4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MAM4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MAM4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MIDV_B_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAM4_SPEC, u32, u32, 18, O>;
...
pub type MIDV_A_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAM4_SPEC, u16, u16, 11, O>;
#[doc = "Field `MIDE` reader - Identifier Version"]
pub type MIDE_R = crate::BitReader<bool>;
#[doc = "Field `MIDE` writer - Identifier Version"]
pub type MIDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAM4_SPEC, bool, O>;
impl R {
...
#[doc = "Mailbox Acceptance Mask Register (MB = 4)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mam4](index.html) module"]
pub struct MAM4_SPEC;
impl crate::RegisterSpec for MAM4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mam4::R](R) reader structure"]
impl crate::Readable for MAM4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mam4::W](W) writer structure"]
impl crate::Writable for MAM4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MAM4 to value 0"]
impl crate::Resettable for MAM4_SPEC {
