#[doc = "Reader of register PRBS7"]
pub type R = crate::R<u32, super::PRBS7>;
#[doc = "Writer for register PRBS7"]
pub type W = crate::W<u32, super::PRBS7>;
#[doc = "Register PRBS7 `reset()`'s with value 0x3333_3333"]
impl crate::ResetValue for super::PRBS7 {
    type Type = u32;
    #[inline(always)]
