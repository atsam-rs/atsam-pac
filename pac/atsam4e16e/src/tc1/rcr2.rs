#[doc = "Reader of register RCR2"]
pub type R = crate::R<u32, super::RCR2>;
#[doc = "Writer for register RCR2"]
pub type W = crate::W<u32, super::RCR2>;
#[doc = "Register RCR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::RCR2 {
    type Type = u32;
    #[inline(always)]
