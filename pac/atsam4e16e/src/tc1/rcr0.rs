#[doc = "Reader of register RCR0"]
pub type R = crate::R<u32, super::RCR0>;
#[doc = "Writer for register RCR0"]
pub type W = crate::W<u32, super::RCR0>;
#[doc = "Register RCR0 `reset()`'s with value 0"]
impl crate::ResetValue for super::RCR0 {
    type Type = u32;
    #[inline(always)]
