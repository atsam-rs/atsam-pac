...
pub struct R(crate::R<MAM1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MAM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MAM1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MAM1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAM1` writer"]
pub struct W(crate::W<MAM1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MAM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MAM1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MAM1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MIDV_B_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAM1_SPEC, u32, u32, 18, O>;
...
pub type MIDV_A_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MAM1_SPEC, u16, u16, 11, O>;
#[doc = "Field `MIDE` reader - Identifier Version"]
pub type MIDE_R = crate::BitReader<bool>;
#[doc = "Field `MIDE` writer - Identifier Version"]
pub type MIDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAM1_SPEC, bool, O>;
impl R {
...
#[doc = "Mailbox Acceptance Mask Register (MB = 1)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mam1](index.html) module"]
pub struct MAM1_SPEC;
impl crate::RegisterSpec for MAM1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mam1::R](R) reader structure"]
impl crate::Readable for MAM1_SPEC {
    type Reader = R;
}
