...
pub struct R(crate::R<MSR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MSR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MSR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MSR1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Mailbox Status Register (MB = 1)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [msr1](index.html) module"]
pub struct MSR1_SPEC;
impl crate::RegisterSpec for MSR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [msr1::R](R) reader structure"]
impl crate::Readable for MSR1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets MSR1 to value 0"]
impl crate::Resettable for MSR1_SPEC {
    #[inline(always)]
