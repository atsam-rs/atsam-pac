...
pub type CPRE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMR0_SPEC, u8, CPRE_A, 4, O>;
...
pub type CALG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
#[doc = "Field `CPOL` reader - Channel Polarity"]
pub type CPOL_R = crate::BitReader<bool>;
#[doc = "Field `CPOL` writer - Channel Polarity"]
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
...
pub type CES_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
...
pub type TCTS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
...
pub type DTE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
...
pub type DTHI_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
...
pub type DTLI_W<'a, const O: u8> = crate::BitWriter<'a, u32, CMR0_SPEC, bool, O>;
impl R {
