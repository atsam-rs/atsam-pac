#[doc = "Reader of register CAE0"]
pub type R = crate::R<u32, super::CAE0>;
#[doc = "Writer for register CAE0"]
pub type W = crate::W<u32, super::CAE0>;
#[doc = "Register CAE0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CAE0 {
    type Type = u32;
    #[inline(always)]
