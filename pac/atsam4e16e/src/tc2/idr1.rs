...
pub type COVFS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `LOVRS` writer - Load Overrun"]
pub type LOVRS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `CPAS` writer - RA Compare"]
pub type CPAS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `CPBS` writer - RB Compare"]
pub type CPBS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `CPCS` writer - RC Compare"]
pub type CPCS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `LDRAS` writer - RA Loading"]
pub type LDRAS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `LDRBS` writer - RB Loading"]
pub type LDRBS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `ETRGS` writer - External Trigger"]
pub type ETRGS_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `ENDRX` writer - End of Receiver Transfer"]
pub type ENDRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
#[doc = "Field `RXBUFF` writer - Reception Buffer Full"]
pub type RXBUFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, IDR1_SPEC, bool, O>;
impl W {
