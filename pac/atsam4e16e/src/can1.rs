...
#[doc = "Timer Register"]
pub mod tim;
#[doc = "TIMESTP (r) register accessor: an alias for `Reg<TIMESTP_SPEC>`"]
...
pub mod ecr;
#[doc = "TCR (w) register accessor: an alias for `Reg<TCR_SPEC>`"]
pub type TCR = crate::Reg<tcr::TCR_SPEC>;
#[doc = "Transfer Command Register"]
pub mod tcr;
#[doc = "ACR (w) register accessor: an alias for `Reg<ACR_SPEC>`"]
