...
impl ARCH_R {
    ...
    pub fn variant(&self) -> Option<ARCH_A> {
        match self.bits {
            ...
            100 => Some(ARCH_A::SAM4CXX_C),
            102 => Some(ARCH_A::SAM4CXX_E),
            ...
            147 => Some(ARCH_A::SAM4NX_A),
            148 => Some(ARCH_A::SAM4NX_B),
            149 => Some(ARCH_A::SAM4NX_C),
            153 => Some(ARCH_A::SAM3SDX_B),
            154 => Some(ARCH_A::SAM3SDX_C),
            165 => Some(ARCH_A::SAM5A),
            176 => Some(ARCH_A::SAM4LX_A),
            177 => Some(ARCH_A::SAM4LX_B),
            178 => Some(ARCH_A::SAM4LX_C),
    ...
    #[doc = "Checks if the value of the field is `SAM4CXX_C`"]
    #[inline(always)]
    pub fn is_sam4cxx_c(&self) -> bool {
        *self == ARCH_A::SAM4CXX_C
    }
    #[doc = "Checks if the value of the field is `SAM4CXX_E`"]
    #[inline(always)]
    pub fn is_sam4cxx_e(&self) -> bool {
        *self == ARCH_A::SAM4CXX_E
    }
    ...
    #[doc = "Checks if the value of the field is `SAM4NX_A`"]
    #[inline(always)]
    pub fn is_sam4nx_a(&self) -> bool {
        *self == ARCH_A::SAM4NX_A
    }
    #[doc = "Checks if the value of the field is `SAM4NX_B`"]
    #[inline(always)]
    pub fn is_sam4nx_b(&self) -> bool {
        *self == ARCH_A::SAM4NX_B
    }
    #[doc = "Checks if the value of the field is `SAM4NX_C`"]
    #[inline(always)]
    pub fn is_sam4nx_c(&self) -> bool {
        *self == ARCH_A::SAM4NX_C
    }
    ...
    #[doc = "Checks if the value of the field is `SAM4LX_A`"]
    #[inline(always)]
    pub fn is_sam4lx_a(&self) -> bool {
        *self == ARCH_A::SAM4LX_A
    }
    #[doc = "Checks if the value of the field is `SAM4LX_B`"]
    #[inline(always)]
    pub fn is_sam4lx_b(&self) -> bool {
        *self == ARCH_A::SAM4LX_B
    }
    #[doc = "Checks if the value of the field is `SAM4LX_C`"]
    #[inline(always)]
    pub fn is_sam4lx_c(&self) -> bool {
        *self == ARCH_A::SAM4LX_C
    }
