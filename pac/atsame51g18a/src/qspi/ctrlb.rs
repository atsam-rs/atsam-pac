...
impl From<LOOPEN_A> for bool {
    #[inline(always)]
    fn from(variant: LOOPEN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `LOOPEN` reader - Local Loopback Enable"]
pub struct LOOPEN_R(crate::FieldReader<bool, LOOPEN_A>);
impl LOOPEN_R {
    pub(crate) fn new(bits: bool) -> Self {
    ...
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> LOOPEN_A {
        match self.bits {
            false => LOOPEN_A::DISABLED,
            true => LOOPEN_A::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        **self == LOOPEN_A::DISABLED
    }
    #[doc = "Checks if the value of the field is `ENABLED`"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        **self == LOOPEN_A::ENABLED
    }
}
impl core::ops::Deref for LOOPEN_R {
    type Target = crate::FieldReader<bool, LOOPEN_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> LOOPEN_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: LOOPEN_A) -> &'a mut W {
        self.bit(variant.into())
    }
    #[doc = "Local Loopback is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
        self.variant(LOOPEN_A::DISABLED)
    }
    #[doc = "Local Loopback is enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut W {
        self.variant(LOOPEN_A::ENABLED)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
